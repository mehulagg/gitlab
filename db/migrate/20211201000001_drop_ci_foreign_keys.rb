...
class DropCiForeignKeys < ActiveRecord::Migration[6.1]
  ...
  def up
    ...
    remove_foreign_key_if_exists(:ci_test_cases, :projects, name: "fk_0526c30ded")
  ...
  def down
    ...
    add_concurrent_foreign_key(:ci_job_token_project_scope_links, :users, name: "fk_rails_35f7f506ce", column: :added_by_id, target_column: :id, on_delete: "set null")
    ...
    add_concurrent_foreign_key(:ci_pipeline_schedules, :users, name: "fk_9ea99f58d2", column: :owner_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:ci_pipelines, :external_pull_requests, name: "fk_190998ef09", column: :external_pull_request_id, target_column: :id, on_delete: "set null")
    ...
    add_concurrent_foreign_key(:ci_test_cases, :projects, name: "fk_0526c30ded", column: :project_id, target_column: :id, on_delete: "cascade")
    ...
    add_concurrent_foreign_key(:merge_requests, :ci_pipelines, name: "fk_fd82eae0b9", column: :head_pipeline_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:merge_trains, :ci_pipelines, name: "fk_rails_f90820cb08", column: :pipeline_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:packages_build_infos, :ci_pipelines, name: "fk_rails_17a9a0dffc", column: :pipeline_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:packages_package_file_build_infos, :ci_pipelines, name: "fk_rails_3e3f630188", column: :pipeline_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:pages_deployments, :ci_builds, name: "fk_rails_c3a90cf29b", column: :ci_build_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:project_pages_metadata, :ci_job_artifacts, name: "fk_69366a119e", column: :artifacts_archive_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:requirements_management_test_reports, :ci_builds, name: "fk_rails_e67d085910", column: :build_id, target_column: :id, on_delete: "set null")
    ...
    add_concurrent_foreign_key(:terraform_state_versions, :ci_builds, name: "fk_04b91e4a9f", column: :ci_build_id, target_column: :id, on_delete: "set null")
    add_concurrent_foreign_key(:vulnerability_feedback, :ci_pipelines, name: "fk_rails_20976e6fd9", column: :pipeline_id, target_column: :id, on_delete: "set null")
    ...
    add_concurrent_foreign_key(:vulnerability_statistics, :ci_pipelines, name: "fk_e8b13c928f", column: :latest_pipeline_id, target_column: :id, on_delete: "set null")
  end
end
