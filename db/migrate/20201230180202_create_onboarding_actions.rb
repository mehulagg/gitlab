...
class CreateOnboardingActions < ActiveRecord::Migration[6.0]
  ...
  def up
    with_lock_retries do
      create_table :onboarding_actions do |t|
        ...
        t.datetime_with_timezone :mr_created_at
