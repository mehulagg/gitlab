...
class AddHasExternalIssueTrackerTrigger < ActiveRecord::Migration[6.0]
  ...
  DOWNTIME = false
  FUNCTION_NAME = 'set_has_external_issue_tracker'.freeze
  TRIGGER_ON_INSERT_NAME = 'trigger_has_external_issue_tracker_on_insert'.freeze
  TRIGGER_ON_UPDATE_NAME = 'trigger_has_external_issue_tracker_on_update'.freeze
  TRIGGER_ON_DELETE_NAME = 'trigger_has_external_issue_tracker_on_delete'.freeze
