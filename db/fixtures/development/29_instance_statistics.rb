...
Gitlab::Seeder.quiet do
  chance_for_decrement = 0.05 # 5% chance that we'll generate smaller count than the previous count
  max_increase = 10000
  max_decrease = 1000
  ...
  measurements = model_class.identifiers.flat_map do |_, id|
    ...
    Array.new(60) do
      ...
      # Very small chance (3%) to have a slight decrease (simulating cleanups, bulk delete)
