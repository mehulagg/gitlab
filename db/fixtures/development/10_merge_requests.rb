...
Gitlab::Seeder.quiet do
  ...
  projects.each do |project|
    ...
    branches.each do |branch_name|
      ...
      Sidekiq::Worker.skipping_transaction_check do
        MergeRequests::CreateService.new(container: project, current_user: developer, params: params).execute
  ...
  Sidekiq::Worker.skipping_transaction_check do
    MergeRequests::CreateService.new(container: project, current_user: User.admins.first, params: params).execute
  end
  print '.'
