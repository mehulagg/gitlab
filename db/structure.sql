...
CREATE SEQUENCE merge_request_cleanup_schedules_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE merge_request_cleanup_schedules_id_seq OWNED BY merge_request_cleanup_schedules.id;
...
ALTER TABLE ONLY merge_request_cleanup_schedules ALTER COLUMN id SET DEFAULT nextval('merge_request_cleanup_schedules_id_seq'::regclass);
...
ALTER TABLE ONLY merge_request_cleanup_schedules
    ADD CONSTRAINT merge_request_cleanup_schedules_pkey PRIMARY KEY (id);
...
CREATE INDEX index_merge_request_cleanup_schedules_on_merge_request_id ON merge_request_cleanup_schedules USING btree (merge_request_id);
...
CREATE INDEX index_mr_cleanup_schedules_timestamps ON merge_request_cleanup_schedules USING btree (scheduled_at, completed_at);
