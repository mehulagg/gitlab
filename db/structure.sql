...
CREATE TABLE application_settings (
    ...
    encrypted_secret_detection_token_revocation_token_iv character varying(255),
    ...
    CONSTRAINT check_ce1049897b CHECK ((char_length(encrypted_secret_detection_token_revocation_token) <= 255)),
