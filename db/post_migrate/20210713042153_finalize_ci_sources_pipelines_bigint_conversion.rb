...
class FinalizeCiSourcesPipelinesBigintConversion < ActiveRecord::Migration[6.1]
  ...
  def swap
    ...
    add_concurrent_foreign_key TABLE_NAME, :ci_builds, column: :source_job_id_convert_to_bigint, on_delete: :cascade, name: 'fk_be5624bf37_tmp'
    ...
    with_lock_retries(raise_on_exhaustion: true) do
      ...
      # Drop original FK on the old int4 `build_id` (fk_be5624bf37)
