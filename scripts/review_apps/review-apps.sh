...
HELM_CMD=$(cat << EOF
  helm upgrade \
    ...
    --set gitlab.gitlab-exporter.annotations.app.gitlab.com/app="${CI_PROJECT_PATH_SLUG}" \
    --set gitlab.gitlab-exporter.annotations.app.gitlab.com/env="${CI_ENVIRONMENT_SLUG}" \
    ...
    --set gitlab.webservice.annotations.app.gitlab.com/app="${CI_PROJECT_PATH_SLUG}" \
    --set gitlab.webservice.annotations.app.gitlab.com/env="${CI_ENVIRONMENT_SLUG}" \
    ...
    --set gitlab-runner.annotations.app.gitlab.com/app="${CI_PROJECT_PATH_SLUG}" \
    --set gitlab-runner.annotations.app.gitlab.com/app="${CI_PROJECT_PATH_SLUG}" \
