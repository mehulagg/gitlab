...
module Elastic
  module Latest
    module Config
      ...
      settings \
        index: {
          number_of_shards: Elastic::AsJSON.new { Elastic::Setting.number_of_shards[:default] },
          number_of_replicas: Elastic::AsJSON.new { Elastic::Setting.number_of_replicas[:default] },
          highlight: {
