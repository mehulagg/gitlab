  ...
  class GroupRepositoryStorageMoves < ::API::Base
    ...
    resource :group_repository_storage_moves do
      desc 'Get a list of all group repository storage moves' do
        ...
        success Entities::GroupRepositoryStorageMove
      end
      params do
        use :pagination
      end
      ...
      get ':repository_storage_move_id' do
        storage_move = GroupRepositoryStorageMove.find(params[:repository_storage_move_id])

        present storage_move, with: Entities::GroupRepositoryStorageMove, current_user: current_user
      end
