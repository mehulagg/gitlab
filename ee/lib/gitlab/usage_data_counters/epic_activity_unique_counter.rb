...
module Gitlab
  module UsageDataCounters
    module EpicActivityUniqueCounter
      ...
      EPIC_END_DATE_SET_AS_FIXED = 'g_project_management_users_setting_epic_end_date_as_fixed'
      EPIC_END_DATE_SET_AS_INHERITED = 'g_project_management_users_setting_epic_end_date_as_inherited'
      ...
      class << self
        ...
        def track_epic_end_date_set_as_fixed_action(author:, time: Time.zone.now)
          track_unique_action(EPIC_END_DATE_SET_AS_FIXED, author, time)
        end

        def track_epic_end_date_set_as_inherited_action(author:, time: Time.zone.now)
          track_unique_action(EPIC_END_DATE_SET_AS_INHERITED, author, time)
        end
