...
module Gitlab
  module UsageDataCounters
    module EpicActivityUniqueCounter
      ...
      EPIC_LABELS = 'g_project_management_epic_labels_changed'
      ...
      class << self
        ...
        def track_epic_labels_changed_action(author:, time: Time.zone.now)
          track_unique_action(EPIC_LABELS, author, time)
        end
