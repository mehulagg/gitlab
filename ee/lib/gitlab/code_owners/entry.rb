...
module Gitlab
  module CodeOwners
    class Entry
      ...
      Data = Struct.new(:pattern, :owner_line, :optional, :section)
      ...
      def initialize(pattern, owner_line, optional = false, section = DEFAULT_SECTION)
        @data = Data.new(pattern, owner_line, optional, section)
      end
