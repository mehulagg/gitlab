    ...
    module Groups
      module Pipelines
        class EpicEventsPipeline
          ...
          transformer ::BulkImports::Common::Transformers::UserReferenceTransformer, reference: 'author_id'
          ...
          def load(context, data)
            ...
            epic = context.group.epics.find_by(iid: context.extra[:epic_iid]) # rubocop: disable CodeReuse/ActiveRecord
