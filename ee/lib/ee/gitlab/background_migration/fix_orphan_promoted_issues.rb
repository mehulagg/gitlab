      ...
      module FixOrphanPromotedIssues
        ...
        def perform(note_id)
          ActiveRecord::Base.connection.execute <<~SQL
            WITH promotion_notes AS #{Arel::Nodes::AsWithMaterialized.add_materialized_if_supported} (
            ...
            ), promoted_epics AS #{Arel::Nodes::AsWithMaterialized.add_materialized_if_supported} (
