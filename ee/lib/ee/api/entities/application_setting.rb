    ...
    module Entities
      module ApplicationSetting
        ...
        prepended do
          ...
          expose :maintenance_mode, if: ->(_instance, _opts) { ::Gitlab::Geo.license_allows? && ::Feature.enabled?(:maintenance_mode, default_enabled: :yaml) }
          expose :maintenance_mode_message, if: ->(_instance, _opts) { ::Gitlab::Geo.license_allows? && ::Feature.enabled?(:maintenance_mode, default_enabled: :yaml) }
