        ...
        prepended do
          params :optional_params_ee do
            ...
            given elasticsearch_indexing: ->(val) { val } do
              ...
              optional :elasticsearch_username, type: String, desc: 'The username to use for connecting to Elasticsearch.'
              optional :elasticsearch_password, type: String, desc: 'The password to use for connecting to Elasticsearch.'
