      ...
      module Menus
        module AnalyticsMenu
          ...
          def configure_menu_items
            ...
            insert_item_after(:ci_cd_analytics, code_review_analytics_menu_item)
            insert_item_after(:code_review, insights_menu_item)
            insert_item_after(:insights, issues_analytics_menu_item)
            insert_item_after(:issues, merge_request_analytics_menu_item)
