    ...
    module Projects
      module Menus
        module SecurityComplianceMenu
          ...
          override :link
          def link
            return project_security_discover_path(context.project) unless has_renderable_items?
          ...
          def security_dashboard_menu_item
            strong_memoize(:security_dashboard_menu_item) do
              ::Sidebars::MenuItem.new(
                ...
                item_id: :dashboard,
                render: -> { can?(context.current_user, :read_project_security_dashboard, context.project) }
              )
            end
          end
          ...
          def on_demand_scans_menu_item
            strong_memoize(:on_demand_scans_menu_item) do
              ::Sidebars::MenuItem.new(
                ...
                render: -> { can?(context.current_user, :read_on_demand_scans, context.project) }
              )
            end
          end
          ...
          def dependencies_menu_item
            strong_memoize(:dependencies_menu_item) do
              ::Sidebars::MenuItem.new(
                ...
                render: -> { can?(context.current_user, :read_dependencies, context.project) }
              )
            end
          end
          ...
          def license_compliance_menu_item
            strong_memoize(:license_compliance_menu_item) do
              ::Sidebars::MenuItem.new(
                ...
                render: -> { can?(context.current_user, :read_licenses, context.project) }
              )
            end
          end
          ...
          def threat_monitoring_menu_item
            strong_memoize(:threat_monitoring_menu_item) do
              ::Sidebars::MenuItem.new(
                ...
                render: -> { can?(context.current_user, :read_threat_monitoring, context.project) }
              )
            end
          end
