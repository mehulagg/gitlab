...
module Vulnerabilities
  module DismissalReasonEnum
    ...
    define do
      ...
      mitigating_control value: 2, description: _('A management, operational, or technical control (i.e., safeguard or countermeasure) employed by an organization that provides equivalent or comparable protection for an information system.')
