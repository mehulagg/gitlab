...
module EE
  module GroupPolicy
    ...
    prepended do
      ...
      condition(:group_saml_available) do
        ::Gitlab::Auth::GroupSaml::Config.enabled? && !group.subgroup? && @subject.feature_available?(:group_saml)
      end
      ...
      rule { group_saml_available & (admin | owner) }.enable :admin_group_saml
