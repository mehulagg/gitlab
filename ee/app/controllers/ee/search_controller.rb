...
module EE
  module SearchController
    ...
    prepended do
      ...
      track_redis_hll_event :show, name: 'i_search_advanced', feature: :search_track_unique_users,
      ...
      track_redis_hll_event :show, name: 'i_search_paid', feature: :search_track_unique_users,
