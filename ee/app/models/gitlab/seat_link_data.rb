...
module Gitlab
  class SeatLinkData
    ...
    attr_reader :timestamp, :key, :max_users, :active_users, :checked_at
    ...
    def initialize(timestamp: nil, key: default_key, max_users: nil, active_users: nil, checked_at: Time.current)
