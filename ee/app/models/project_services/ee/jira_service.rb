...
module EE
  module JiraService
    ...
    def new_issue_url_with_predefined_fields(summary, description)
      ...
      "#{url}/secure/CreateIssueDetails!init.jspa?pid=#{jira_project_id}&issuetype=#{vulnerabilities_issuetype}&summary=#{escaped_summary}&description=#{escaped_description}"
    end
