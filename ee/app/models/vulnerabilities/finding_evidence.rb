...
module Vulnerabilities
  class FindingEvidence < ApplicationRecord
    ...
    has_many :finding_evidence_requests, class_name: 'Vulnerabilities::FindingEvidenceRequest', inverse_of: :finding_evidence, foreign_key: 'vulnerability_finding_evidences_id'
  end
end
