...
module IncidentManagement
  module PendingEscalations
    class Alert < ApplicationRecord
      ...
      ignore_columns :oncall_schedule_id, :status, remove_with: '14.3', remove_after: '2021-08-22'
      ...
      belongs_to :rule, class_name: 'EscalationRule', foreign_key: 'rule_id', inverse_of: :pending_alert_escalations
