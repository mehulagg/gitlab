...
module MergeTrains
  class RefreshMergeRequestService < BaseService
    ...
    def create_pipeline!
      ...
      # TODO: Maybe canceling and refreshing pipeline could be part of the CreatePipelineService above
      pipeline = result[:pipeline]
      merge_train.cancel_pipeline!(pipeline)
      merge_train.refresh_pipeline!(pipeline.id) # TODO: we can pass `pipeline` object instead. It's more OOP
