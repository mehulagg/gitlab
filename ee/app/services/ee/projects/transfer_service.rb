    ...
    module TransferService
      ...
      def update_elasticsearch_hooks
        ...
        if old_namespace.use_elasticsearch? != new_namespace.use_elasticsearch?
          ...
          ::Elastic::ProcessInitialBookkeepingService.backfill_projects!(project) if project.maintaining_elasticsearch? # rubocop: disable CodeReuse/ServiceClass
          project.maintain_elasticsearch_destroy unless project.maintaining_elasticsearch?
        end
      end
    end
  end
