    ...
    module UpdateService
      ...
      def execute
        ...
        if result = super
          ...
          update_elasticsearch_index_settings(number_of_replicas: elasticsearch_replicas.to_i, number_of_shards: elasticsearch_shards.to_i)
        end
      ...
      def update_elasticsearch_index_settings(number_of_replicas:, number_of_shards:)
        Elastic::Setting.current.update(
