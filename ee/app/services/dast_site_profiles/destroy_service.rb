...
module DastSiteProfiles
  class DestroyService < BaseService
    ...
    def execute(id:)
      ...
      return ServiceResponse.error(message: 'Cannot delete profile referenced in security policy') if referenced_in_security_policy?(dast_site_profile)
    ...
    def unauthorized
      ::ServiceResponse.error(message: _('You are not authorized to update this site profile'), http_status: 403)
    end
