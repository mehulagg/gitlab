  ...
  module SecurityOrchestrationPolicies
    class OnDemandScanPipelineConfigurationService
      ...
      def prepare_on_demand_scan_configuration(action)
        result = prepare_on_demand_scan_config(action[:site_profile], action[:scanner_profile])
      ...
      def prepare_on_demand_scan_config(site_profile_name, scanner_profile_name)
        ...
        AppSec::Dast::ScanConfigs::CreateService
