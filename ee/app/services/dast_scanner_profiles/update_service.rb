...
module DastScannerProfiles
  class UpdateService < BaseService
    ...
    def execute(id:, profile_name:, target_timeout:, spider_timeout:, scan_type:, ajax_spider:, show_debug_messages:)
      ...
      if dast_scanner_profile.update(name: profile_name, target_timeout: target_timeout, spider_timeout: spider_timeout, scan_type: scan_type, ajax_spider: ajax_spider, show_debug_messages: show_debug_messages)
