  ...
  def dast_configuration_data(project)
    {
      ...
      scanner_profile_library_path => project_security_configuration_dast_scans_path(project, anchor: 'scanner-profiles'),
      site_profile_library_path => project_security_configuration_dast_scans_path(project, anchor: 'site-profiles'),
