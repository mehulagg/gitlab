...
module EE
  module WikiHelper
    ...
    override :wiki_ssh_clone_button
    ...
    def wiki_kerberos_clone_button(wiki)
      klass = 'kerberos-selector has-tooltip'

      content_tag :a, 'KRB5',
        class: klass,
        href: wiki.kerberos_url_to_repo,
        data: {
          html: 'true',
          placement: 'right',
          container: 'body',
