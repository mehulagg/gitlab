  ...
  >
    <p>
      <gl-alert :dismissible="false">
        <gl-sprintf :message="__('These will be sent to %{email} as an attachment once finished.')">
          <template #email>
            <strong>{{ email }}</strong>
          </template>
        </gl-sprintf>
    ...
    <div>
      <h5 class="gl-mb-0! gl-mt-6">{{ __('Advanced export options') }}</h5>
      <p class="gl-mb-3">
      ...
      <div class="scrollbox">
        ...
        <div class="gl-pt-5 scrollbox-body">
          <gl-form-checkbox
