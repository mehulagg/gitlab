...
export const userNotifications = {
  manualSyncSuccessful: s__('SuperSonics|The subscription details synced successfully.'),
  manualSyncFailure: s__(
    'SuperSonics|There is a connectivity Issue. You can no longer sync your subscription details with GitLab. Get help for the most common connectivity issues by %{connectivityHelpLinkStart}troubleshooting the activation code%{connectivityHelpLinkSEnd}.',
  ),
};
