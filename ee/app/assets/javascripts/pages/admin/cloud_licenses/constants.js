...
export const connectivityErrorAlert = {
  subtitle: s__(
    'SuperSonics|To activate your subscription, connect to GitLab servers through the %{linkStart}Cloud Licensing service%{linkEnd}, a hassle-free way to manage your subscription.',
  ),
  helpText: s__(
