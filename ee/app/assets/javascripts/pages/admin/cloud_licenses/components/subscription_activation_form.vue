        ...
        <div class="gl-display-flex gl-flex-wrap">
          ...
          <gl-form-checkbox v-model="termsAccepted">
            <gl-sprintf
              :message="
                s__(
                  'CloudLicense|I agree that my use of GitLab Software is subject to the %{linkStart}Subscription Agreement%{linkEnd}, unless otherwise agreed to in writing with GitLab.',
                )
              "
            >
              <template #link="{ content }">
