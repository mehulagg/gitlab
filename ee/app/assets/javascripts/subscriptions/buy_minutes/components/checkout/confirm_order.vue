...
export default {
  ...
  i18n: {
    ...
    errorWithMessage: s__('Checkout|Failed to confirm your order: %{message}. Please try again.'),
    errorWithoutMessage: s__('Checkout|Failed to confirm your order! Please try again.'),
  },
};
</script>
<template>
