...
import { EXTEND_AS, EPICS_LIMIT, EPICS_LIMIT_DISMISSED_COOKIE_NAME } from '../constants';
...
export default {
  ...
  computed: {
    ...
    isWarningVisible() {
      return !this.isWarningDismissed && this.epics.length > EPICS_LIMIT;
    },
  },
  mounted() {
    this.fetchEpics();
