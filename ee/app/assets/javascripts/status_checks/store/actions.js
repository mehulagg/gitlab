...
export const fetchStatusChecks = ({ rootState, commit }) => {
...
export const putStatusCheck = ({ rootState, dispatch }, statusCheck) => {
  const { statusChecksPath } = rootState.settings;
...
export const postStatusCheck = ({ rootState, dispatch }, statusCheck) => {
  const { statusChecksPath } = rootState.settings;
