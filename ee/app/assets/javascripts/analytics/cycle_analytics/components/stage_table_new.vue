...
const WORKFLOW_COLUMN_TITLES = {
  issues: { thClass: 'gl-w-half', key: 'workflowTitleKey', label: __('Issues') },
  jobs: { thClass: 'gl-w-half', key: 'workflowTitleKey', label: __('Jobs') },
  deployments: { thClass: 'gl-w-half', key: 'workflowTitleKey', label: __('Deployments') },
  mergeRequests: { thClass: 'gl-w-half', key: 'workflowTitleKey', label: __('Merge requests') },
};
