...
<template>
  <gl-empty-state
    ...
    :description="
      s__(
        `SecurityReports|Although it's rare to have no vulnerabilities for your group, it can happen. Check your settings to make sure you've set up your dashboard correctly.`,
      )
    "
  />
</template>
