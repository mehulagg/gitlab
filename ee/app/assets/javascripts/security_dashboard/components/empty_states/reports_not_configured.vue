...
export default {
  ...
  i18n: {
    ...
    description: s__(
      'SecurityReports|Manage and track vulnerabilities identified in your project. Projects with security testing configured will have their results show here.',
    ),
