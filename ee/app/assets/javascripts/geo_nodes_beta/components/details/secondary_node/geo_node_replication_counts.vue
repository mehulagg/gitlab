...
<template>
  <div>
    <div class="gl-display-flex gl-align-items-center gl-mb-3">
      <span class="gl-flex-fill-1">{{ s__('Geo|Data type') }}</span>
      <span class="gl-flex-fill-1">{{ s__('Geo|Synchronization') }}</span>
      <span class="gl-flex-fill-1">{{ s__('Geo|Verification') }}</span>
    </div>
    <div
      v-for="type in replicationOverview"
      :key="type.title"
      class="gl-display-flex gl-align-items-center gl-mb-3"
      data-testid="replicationType"
    >
      <span class="gl-flex-fill-1" data-testid="replicableTitle">{{ type.title }}</span>
      <div class="gl-display-flex gl-align-items-center gl-flex-fill-1" data-testid="syncData">
        <div
