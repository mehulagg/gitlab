...
export default {
  ...
  computed: {
    ...
    learnMoreUrl() {
      return 'https://docs.gitlab.com/ee/user/clusters/agent/#create-an-agent-record-in-gitlab';
    },
  },
  methods: {
    createdByName(token) {
      return token?.createdByUser?.name;
    },
  },
};
</script>
...
<template>
  <div v-if="tokens.length">
    <div class="gl-display-block gl-text-right gl-my-5">
