...
<template>
  <div class="discover-box">
    ...
    <div class="discover-carousels">
      ...
      <div class="discover-footer gl-mx-auto my-0">
        <p class="gl-text-gray-900 gl-text-center mb-5">
    ...
    <div class="discover-buttons gl-display-flex gl-flex-direction-row gl-justify-content-space-between gl-mx-auto">
      <gl-button
