<script>
import subscriptionSuccessSvg from '@gitlab/svgs/dist/illustrations/subscription-success.svg';
...
<template>
  ...
  >
    <div class="trial-activated-graphic gl-display-flex gl-justify-content-center gl-mt-5">
      <span v-safe-html="$options.subscriptionSuccessSvg" class="svg-container"></span>
    </div>
