...
RSpec.describe 'Billings > Extend / Reactivate Trial', :js do
  ...
  shared_examples 'a reactivatable trial' do
    ...
    it 'displays the "Reactivate trial" button' do
      expect(page).to have_button('Reactivate trial')
    end
  ...
  shared_examples 'an extendable trial' do
    ...
    it 'displays the "Extend trial" button' do
      expect(page).to have_button('Extend trial')
    end
