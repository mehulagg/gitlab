...
import PipelineVulnerabilities from 'ee/security_dashboard/components/pipeline_findings.vue';
...
describe('Pipeline findings', () => {
  ...
  const createWrapper = ({ props = {}, mocks, apolloProvider } = {}) => {
    ...
    wrapper = shallowMount(PipelineVulnerabilities, {
      localVue,
      apolloProvider,
      provide: {
  ...
  describe('with findings', () => {
    ...
    it('passes down vulnerabilities', () => {
