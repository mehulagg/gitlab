...
import ProjectVulnerabilitiesApp, {
  SCANNER_ALERT_DISMISSED_LOCAL_STORAGE_KEY,
} from 'ee/security_dashboard/components/project_vulnerabilities.vue';
  ...
  describe('security scanner alerts', () => {
    ...
    describe('dismissal', () => {
      ...
      it('should hide the alert when it is dismissed', async () => {
        ...
        // Must call find helper again rather than using constant so as not to
