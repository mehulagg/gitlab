...
describe('Subscription Seats', () => {
  ...
  describe('heading text', () => {
    it('contains the group name and total seats number', () => {
      expect(findHeading().text()).toMatch('Test Group Name');
  ...
  describe('pagination', () => {
    it('is rendered and passed correct values', () => {
      expect(findPagination().vm.value).toEqual(1);
      expect(findPagination().props('perPage')).toEqual(5);
      expect(findPagination().props('totalItems')).toEqual(300);
    });
