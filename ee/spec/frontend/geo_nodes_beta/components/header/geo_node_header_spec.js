...
describe('GeoNodeHeader', () => {
  ...
  const findHeaderCollapseIcon = () => wrapper.find(GlIcon);
    ...
    describe('Header Collapse Icon', () => {
      describe('when not collapsed', () => {
        ...
        it('renders the chevron-down icon', () => {
          expect(findHeaderCollapseIcon().attributes('name')).toBe('chevron-down');
        });
      });
      ...
      describe('when collapsed', () => {
        ...
        it('renders the chevron-right icon', () => {
          expect(findHeaderCollapseIcon().attributes('name')).toBe('chevron-right');
        });
      });
      ...
      describe('on click', () => {
        beforeEach(() => {
          ...
          findHeaderCollapseIcon().vm.$emit('click');
        });
