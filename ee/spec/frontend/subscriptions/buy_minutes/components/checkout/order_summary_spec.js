...
import { stateData as mockStateData } from 'ee_jest/subscriptions/buy_minutes/mock_data';
...
describe('Order Summary', () => {
  ...
  const initialStateData = {
    state: { subscription: { planId: 'gold' } },
  };
  let wrapper;
  ...
  describe('Changing the company name', () => {
    describe('When purchasing for a single user', () => {
      beforeEach(() => {
        createComponent({ state: { isSetupForCompany: false } });
      });
    ...
    describe('When purchasing for a company or group', () => {
      describe('Without a group name provided', () => {
        beforeEach(() => {
          createComponent({ state: { isSetupForCompany: true } });
        });
      ...
      describe('With a group name provided', () => {
        beforeEach(() => {
          createComponent({
            state: { isSetupForCompany: true, customer: { company: 'My group' } },
          });
        });
  ...
  describe('Changing the plan', () => {
    ...
    describe('the default plan', () => {
      beforeEach(() => {
        createComponent({
          state: { subscription: { planId: 'bronze', quantity: 1 } },
        });
      });
  ...
  describe('Changing the number of users', () => {
    beforeEach(() => {
      createComponent({
        state: { subscription: { planId: 'gold', quantity: 1 } },
      });
    });
    ...
    describe('3 selected users', () => {
      beforeEach(() => {
        createComponent({
          state: { subscription: { planId: 'gold', quantity: 3 } },
        });
      });
    ...
    describe('no selected users', () => {
      beforeEach(() => {
        createComponent({
          state: { subscription: { planId: 'gold', quantity: 0 } },
        });
      });
