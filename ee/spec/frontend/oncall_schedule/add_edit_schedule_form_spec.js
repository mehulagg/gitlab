...
describe('AddEditScheduleForm', () => {
  ...
  describe('Form validation', () => {
    describe('Timezone select', () => {
      it('has a validation message/red border when the validated timezone state is false', () => {
        createComponent({
          props: {
            schedule: null,
      ...
      it('does not have a validation message/red border when the validated timezone state is true', async () => {
        createComponent({
          props: {
