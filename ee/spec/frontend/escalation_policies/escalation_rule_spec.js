...
describe('EscalationRule', () => {
  ...
  describe('Validation', () => {
    describe.each`
      ...
      ${{ isTimeValid: true, isScheduleValid: false, isUserValid: true }}  | ${'true'}    | ${EMAIL_ONCALL_SCHEDULE_USER}
      ${{ isTimeValid: true, isScheduleValid: true, isUserValid: false }}  | ${'true'}    | ${EMAIL_USER}
