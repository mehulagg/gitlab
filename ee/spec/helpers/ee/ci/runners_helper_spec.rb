...
RSpec.describe EE::Ci::RunnersHelper do
  ...
  context 'with notifications' do
    ...
    describe '.root_ancestor_namespace' do
      ...
      context 'with no project and a namespace' do
        let(:project) { nil }
      ...
      context 'with no project or namespace' do
        let(:project) { nil }
        let(:namespace) { nil }

        it 'returns the current user namespace' do
          expect(root_ancestor).to eq user.namespace
        end
      end
    end
  end
