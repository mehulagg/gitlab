...
RSpec.describe EE::NamespaceStorageLimitAlertHelper do
  ...
  describe '#namespace_storage_alert' do
    ...
    where(:feature_flag_enabled, :service_class_name) do
      true  | Namespaces::CheckStorageSizeService
      false | Namespaces::CheckExcessStorageSizeService
    end

    with_them do
      before do
        stub_feature_flags(namespace_storage_limit: feature_flag_enabled)
  ...
  describe '#namespace_storage_purchase_link' do
    ...
    where(:is_dev_or_com, :auto_storage_allocation_enabled, :additional_storage_enabled, :buy_storage_link_enabled, :result) do
