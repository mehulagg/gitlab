...
RSpec.describe VulnerabilitiesHelper do
  ...
  RSpec.shared_examples 'vulnerability properties' do
    ...
    let(:desired_serializer_fields) { %i[metadata identifiers name issue_feedback merge_request_feedback project project_fingerprint scanner uuid dismissal_feedback] }
