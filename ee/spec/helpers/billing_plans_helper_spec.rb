...
RSpec.describe BillingPlansHelper do
  ...
  describe '#upgrade_button_css_classe' do
    ...
    let(:plan) { Hashie::Mash.new(deprecated: false) }
    let(:deprecated_plan) { Hashie::Mash.new(deprecated: true) }
  ...
  describe '#available_plans' do
    let(:plan) { Hashie::Mash.new(deprecated: false, code: 'silver') }
    let(:deprecated_plan) { Hashie::Mash.new(deprecated: true, code: 'bronze') }
