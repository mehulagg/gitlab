...
RSpec.describe Sidebars::Projects::Menus::SecurityComplianceMenu do
  ...
  describe '#link' do
    ...
    where(:show_discover_project_security, :security_dashboard_feature, :audit_events_feature, :dependency_scanning_feature, :expected_link) do
      true  | true  | true  | true | '/-/security/discover'
      false | true  | true  | true | '/-/security/dashboard'
      false | false | true  | true | '/-/audit_events'
      false | false | false | true | '/-/dependencies'
