  ...
  describe '#check_valid_actor!' do
    context 'key expiration is enforced' do
      ...
      it 'does not allow expired keys', :aggregate_failures do
        expect { push_changes }.to raise_forbidden('Your SSH key is no longer valid and expiration is enforced by your instance administrator.')
        expect { pull_changes }.to raise_forbidden('Your SSH key is no longer valid and expiration is enforced by your instance administrator.')
      end
    end
  end
