...
RSpec.describe Gitlab::Ci::Minutes::BuildConsumption do
  ...
  let(:build) { create(:ci_build, runner: runner, project: project) }
  ...
  describe '#amount' do
    ...
    where(:duration, :visibility_level, :public_cost_factor, :private_cost_factor, :result) do
      10 | Gitlab::VisibilityLevel::PRIVATE | 1.0 | 2.0 | 20
      10 | Gitlab::VisibilityLevel::INTERNAL | 1.0 | 2.0 | 20
      10 | Gitlab::VisibilityLevel::INTERNAL | 1.0 | 1.5 | 15
      10 | Gitlab::VisibilityLevel::PUBLIC | 2.0 | 1.0 | 20
      3  | Gitlab::VisibilityLevel::PUBLIC | 0.5 | 1.0 | 1
    end
