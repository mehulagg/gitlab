    ...
    context 'file name rules' do
      ...
      context 'file name regex check' do
        ...
        it "returns an error if a new or renamed filed doesn't match the file name regex" do
          expect { subject.validate! }.to raise_error(Gitlab::GitAccess::ForbiddenError, "File name README was prohibited by the denylist pattern READ*.")
        end
      ...
      context 'blacklisted files check' do
        ...
        it "returns an error if a new or renamed filed doesn't match the file name regex" do
          ...
          black_listed.each do |file_path|
            ...
            expect { subject.validate! }.to raise_error(Gitlab::GitAccess::ForbiddenError, /File name #{file_path} was prohibited by the denylist pattern/)
          end
        end
      end
    end
