...
RSpec.describe AppSec::Dast::Profiles::FetchService do
  ...
  describe '#execute' do
    ...
    shared_examples 'a fetch operation' do |param_key|
      let(:expected_variables) { profile.ci_variables.to_runner_variables }
      ...
      context 'when licensed' do
        ...
        context 'when the profile does not exist' do
          let(param_key) { SecureRandom.hex }
