...
RSpec.describe ExternalApprovalRules::UpdateService do
  ...
  let(:params) { { external_url: 'http://newvalue.com', name: 'new name', protected_branch_ids: [protected_branch.id] } }

  subject { described_class.new(container: rule, current_user: current_user, params: params).execute }
