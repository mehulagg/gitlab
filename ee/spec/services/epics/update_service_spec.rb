    ...
    context 'when Epic has tasks' do
      ...
      context 'when tasks are marked as completed' do
        ...
        it 'counts the change correctly' do
          expect(Gitlab::UsageDataCounters::EpicActivityUniqueCounter).to receive(:track_epic_task_complete)
      ...
      context 'when tasks are marked as incomplete' do
        ...
        it 'counts the change correctly' do
          expect(Gitlab::UsageDataCounters::EpicActivityUniqueCounter).to receive(:track_epic_task_incomplete)
            .with(author: user).twice
