...
RSpec.describe GroupWikiRepository, :geo do
  ...
  describe 'Geo Replication' do
    ...
    context 'with root group and subgroup wikis' do
      ...
      let!(:root_group_wiki_repository) { create(:group_wiki_repository, group: root_group) }
      let!(:subgroup_wiki_repository) { create(:group_wiki_repository, group: subgroup) }
      let!(:broken_wiki_repository) { create(:group_wiki_repository, shard_name: 'broken') }
