  ...
  describe 'validations' do
    ...
    context 'when the project_id and dast_site_profile.project_id do not match' do
      ...
      it 'is not valid' do
        ...
        expect(subject.errors.full_messages).to include('Project does not match dast_site_profile.project')
      end
    end
    ...
    context 'when the project_id and dast_scanner_profile.project_id do not match' do
      ...
      it 'is not valid' do
        expect(subject.valid?).to be_falsey
        expect(subject.errors.full_messages).to include('Project does not match dast_scanner_profile.project')
      end
    end
  end
end
