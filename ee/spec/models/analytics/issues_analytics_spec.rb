...
RSpec.describe Analytics::IssuesAnalytics do
  subject { described_class.new(issuables: project.issues) }
  ...
  describe '#monthly_counters' do
    ...
    context 'without month_back specified' do
    ...
    context 'without month_back specified' do
      subject { described_class.new(issuables: project.issues, months_back: 3) }
