...
RSpec.describe EE::Namespace::RootStorageStatistics do
  describe '#recalculate!' do
    ...
    context 'when namespace belong to  a group' do
      ...
      let_it_be(:namespace_stat1) { create(:namespace_statistics, namespace: group1, storage_size: 200, wiki_size: 200) }
      let_it_be(:namespace_stat2) { create(:namespace_statistics, namespace: group2, storage_size: 300, wiki_size: 300) }
      ...
      it 'aggregates namespace statistics' do
        ...
        total_wiki_size = project_stat1.wiki_size + project_stat2.wiki_size + root_namespace_stat.wiki_size + namespace_stat1.wiki_size + namespace_stat2.wiki_size
        total_storage_size = project_stat1.storage_size + project_stat2.storage_size + root_namespace_stat.storage_size + namespace_stat1.storage_size + namespace_stat2.storage_size
