...
RSpec.describe Iteration do
  ...
  describe '.filter_by_state' do
    ...
    let_it_be(:current_iteration) { create(:iteration, :started, :skip_future_date_validation, group: group, start_date: 1.day.ago, due_date: 6.days.from_now) }
  ...
  describe '.by_iteration_cadence_ids' do
    ...
    let_it_be(:current_iteration) { create(:iteration, :started, :skip_future_date_validation, iterations_cadence: iterations_cadence2, group: group, start_date: 1.day.ago, due_date: 6.days.from_now) }
