...
RSpec.describe Integrations::Jira do
  ...
  describe '#new_issue_url_with_predefined_fields' do
    ...
    let(:expected_new_issue_url) { "#{jira_integration.url}/secure/CreateIssueDetails!init.jspa?pid=11223&issuetype=10001&summary=Special+Summary%21%3F&description=%2AID%2A%3A+2%0A_Issue_%3A+%21" }
