  ...
  describe '.max_historical_user_count' do
    ...
    context 'with data outside of the given period' do
      context 'with stats before the given period' do
        before do
          described_class.create!(recorded_at: from - 2.days, active_user_count: 10)
        end
      ...
      context 'with stats after the given period' do
        before do
          described_class.create!(recorded_at: to + 2.days, active_user_count: 10)
        end
    ...
    context 'with data inside of the given period' do
      before do
        described_class.create!(recorded_at: from + 2.days, active_user_count: 10)
        described_class.create!(recorded_at: from + 5.days, active_user_count: 15)
      end
