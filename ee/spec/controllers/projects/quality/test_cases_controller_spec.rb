...
RSpec.describe Projects::Quality::TestCasesController do
  ...
  describe 'GET' do
    describe '#index' do
      let_it_be(:authorized_user) { create(:project_member, :guest, project: project).user }
    ...
    describe '#new' do
      let_it_be(:authorized_user) { create(:project_member, :reporter, project: project).user }
      let_it_be(:unauthorized_user) { create(:user) }
