...
RSpec.describe API::Analytics::ProjectLeadTime do
  ...
  def make_mr(proj, created_at = DateTime.now.utc, merged_at = nil)
    create(:merge_request,
      ...
      target_project: proj).metrics.tap do |metrics|
        metrics.update!(merged_at: merged_at) if merged_at
      end
  end
  ...
  let_it_be(:mr_2020_01_03) { make_mr(project, DateTime.new(2020, 1, 3)) }
  ...
  let_it_be(:mr_2020_02_03) { make_mr(project, DateTime.new(2020, 2, 3)) }
  ...
  let_it_be(:mr_2020_03_03) { make_mr(project, DateTime.new(2020, 3, 3)) }
  ...
  let_it_be(:mr_2020_04_03) { make_mr(project, DateTime.new(2020, 4, 3)) }
