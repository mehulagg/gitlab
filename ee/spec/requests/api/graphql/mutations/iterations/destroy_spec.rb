...
RSpec.describe 'Destroying an iteration' do
  ...
  let(:mutation) do
    graphql_mutation(:destroy_iteration, params)
  end

  def mutation_response
    graphql_mutation_response(:destroy_iteration)
  end
  ...
  context 'when the user has permission' do
    ...
    context 'when iterations feature is enabled' do
      ...
      it 'destroys the iteration', :aggregate_failures do
        expect do
