      ...
      context 'record exists' do
        ...
        it 'includes a serialized dast_profile in the response body' do
          ...
          json_data = {
            ...
            excluded_urls:  dast_site_profile.excluded_urls,
            request_headers:  Dast::SiteProfilePresenter::REDACTED_REQUEST_HEADERS,
            auth: {
              enabled: dast_site_profile.auth_enabled,
              url: dast_site_profile.auth_url,
              username: dast_site_profile.auth_username,
              username_field: dast_site_profile.auth_username_field,
              password: Dast::SiteProfilePresenter::REDACTED_PASSWORD,
              password_field: dast_site_profile.auth_password_field
            },
            referenced_in_security_policies: dast_site_profile.referenced_in_security_policies
          }.to_json
