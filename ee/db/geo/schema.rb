...
ActiveRecord::Schema.define(version: 2020_12_08_031224) do
  ...
  create_table "package_file_registry", id: :serial, force: :cascade do |t|
    ...
    t.index ["verification_retry_at"], name: "package_file_registry_failed_verification", order: "NULLS FIRST", where: "(verification_state = 3)"
    t.index ["verification_state"], name: "package_file_registry_needs_verification", where: "((verification_state = 0) OR (verification_state = 3))"
    t.index ["verified_at"], name: "package_file_registry_pending_verification", order: "NULLS FIRST", where: "(verification_state = 0)"
  end
