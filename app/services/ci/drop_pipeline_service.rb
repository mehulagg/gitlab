...
module Ci
  class DropPipelineService
    ...
    def execute_async_for_all(pipelines, failure_reason)
      pipelines.cancelable.find_each do |pipeline|
        Ci::DropPipelineWorker.perform_async(pipeline.id, failure_reason)
      end
    end
