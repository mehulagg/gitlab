...
module Ci
  class CreatePipelineService < BaseService
    ...
    def execute(source, ignore_skip_ci: false, save_config_errors: true, save_skipped_pipelines: true, trigger_request: nil, schedule: nil, merge_request: nil, external_pull_request: nil, bridge: nil, **options, &block)
