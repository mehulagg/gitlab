...
module MergeRequests
  module MergeStrategies
    class MergeService < MergeRequests::MergeStrategies::BaseService
    ...
    class MergeService < MergeRequests::MergeBaseService
      ...
      def execute(merge_request)
        if project.merge_requests_ff_only_enabled && !self.is_a?(FfMergeService)
          MergeRequests::MergeStrategies::FfMergeService.new(project, current_user, params).execute(merge_request)
          return
        end
