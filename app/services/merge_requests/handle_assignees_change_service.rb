...
module MergeRequests
  class HandleAssigneesChangeService < MergeRequests::BaseService
    def async_execute(merge_request, old_assignees, options = {})
      if Feature.enabled?(:async_handle_merge_request_assignees_change, merge_request.project, default_enabled: :yaml)
    ...
    def execute(merge_request, old_assignees, options = {})
      ...
      notification_service.reassigned_merge_request(merge_request, current_user, old_assignees.to_a)
