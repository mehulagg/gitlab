...
module Spam
  ...
  # referrer = The HTTP referrer. Obtained from request.env['HTTP_REFERRER']
  #
  ...
  class SpamParams
    ...
    attr_reader :captcha_response, :spam_log_id, :ip_address, :user_agent, :referrer

    def initialize(captcha_response:, spam_log_id:, ip_address:, user_agent:, referrer:)
