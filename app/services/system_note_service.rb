...
module SystemNoteService
  ...
  def auto_resolve_alert(alert, monitoring_tool)
    ::SystemNotes::AlertManagementService.new(noteable: alert, project: alert.project).auto_resolve_alert(monitoring_tool)
  end
