...
<template>
  ...
  >
    ...
    <div class="gl-display-flex">
      <span class="gl-white-space-pre-wrap">
        <gl-sprintf :message="__('Open: %{open}')">
          <template #open>
            <gl-link v-if="openPath" ref="openPath" :href="openPath">{{ open }}</gl-link>
      ...
      <template v-if="showMerged">
        ...
        <span class="gl-white-space-pre-wrap">
          <gl-sprintf :message="__('Merged: %{merged}')">
            <template #merged>
              <gl-link v-if="mergedPath" ref="mergedPath" :href="mergedPath">{{ merged }}</gl-link>
      ...
      <span class="gl-white-space-pre-wrap">
        <gl-sprintf :message="__('Closed: %{closed}')">
          <template #closed>
            <gl-link v-if="closedPath" ref="closedPath" :href="closedPath">{{ closed }}</gl-link>
