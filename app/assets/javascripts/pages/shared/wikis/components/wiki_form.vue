...
export default {
  i18n: {
    ...
    contentEditor: {
      ...
      switchToOldEditor: {
        label: s__('Switch me back to the classic editor.'),
        helpText: s__(
  ...
  computed: {
    ...
    contentEditorFeedbackIssue() {
      return 'https://gitlab.com/gitlab-org/gitlab/-/issues/333253';
    },
    ...
    contentEditorHelpPath() {
      return setUrlFragment(this.pageInfo.helpPath, 'content-editor');
    },
    isMarkdownFormat() {
          ...
          <gl-alert class="gl-mb-6" variant="tip" :dismissable="false">
            <gl-sprintf :message="$options.i18n.contentEditor.feedbackTip">
              <template
                ...
                { content }"
                ><gl-link
                  :href="contentEditorFeedbackIssue"
                  target="_blank"
