...
export const getOverlappingDaysInIntervals = (dirtyIntervalLeft, dirtyIntervalRight) => {
  ...
  if (!(leftStartTime <= leftEndTime && rightStartTime <= rightEndTime)) {
    throw new RangeError(__('Invalid interval'))
  }
  ...
  return { overlap: Math.ceil(differenceInMs / MILLISECONDS_IN_DAY), overlapStartDate, overlapEndDate }
}