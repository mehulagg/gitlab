...
import { integrationTypesNew, JSON_VALIDATE_DELAY } from '../constants';
  ...
  i18n: {
    integrationFormSteps: {
      ...
      step3: {
        ...
        help: s__(
          'AlertSettings|Utilize the URL and authorization key below to authorize an external service to send Alerts to GitLab. Review your choosen services documentation to learn where to add these details, and the %{linkStart}GitLab documentation%{linkEnd} to learn more about configuring your endpoint.',
        ),
      },
      step4: {
        label: s__('AlertSettings|4. Test integration(optional)'),
        help: s__(
          'AlertSettings|Provide an example payload from the monitoring tool you intend to intergrate with to send a test alert to the %{linkStart}alerts page%{linkEnd}. This payload can be used to test the intergration using the "save and test payload" button.',
        ),
