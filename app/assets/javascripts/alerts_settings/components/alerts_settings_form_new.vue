  ...
  i18n: {
    integrationFormSteps: {
      ...
      step3: {
        ...
        help: s__(
          'AlertSettings|Utilize the URL and authorization key below to authorize an external service to send alerts to GitLab. Review your external services documentation to learn where to add these details, and the %{linkStart}GitLab documentation%{linkEnd} to learn more about configuring your endpoint.',
        ),
        prometheusHelp: s__(
    ...
    <gl-collapse v-model="formVisible" class="gl-mt-3">
      ...
      <div v-else>
        ...
        >
          <alert-settings-form-help-block
            :message="
              selectedIntegration === $options.typeSet.prometheus
        ...
        >
          ...
          <template v-if="showMappingBuilder">
            <gl-button v-if="canEditPayload" v-gl-modal.resetPayloadModal :disabled="!active">
              {{ $options.i18n.integrationFormSteps.step4.editPayload }}
            </gl-button>

            <gl-button v-else :disabled="!active" :loading="parsingPayload" @click="parseMapping">
