...
export const i18n = {
  ...
  integrationFormSteps: {
    ...
    enableIntegration: {
      ...
      help: s__(
        'AlertSettings|A webhook URL and authorization key is generated for the integration. After you save the integration in the “View credentials” tab, both are visible.',
      ),
    },
    setupCredentials: {
      help: s__(
    ...
    restKeyInfo: {
      label: s__(
        'AlertSettings|If you reset the authorization key for this project, you must update the key in every enable alert source.',
      ),
    },
  },
  ...
  alertSent: s__(
    'AlertsIntegrations|The test alert should now be visible in your alerts list.',
  ),
