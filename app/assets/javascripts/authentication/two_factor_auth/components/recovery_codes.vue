...
export default {
  ...
  created() {
    ...
    this.$options.mousetrap.bind(keysFor(MISC_COPY_TWO_FACTOR_CODES), this.handleKeyboardCopy);
  },
  beforeDestroy() {
    ...
    this.$options.mousetrap.unbind(keysFor(MISC_COPY_TWO_FACTOR_CODES));
  },
  methods: {
