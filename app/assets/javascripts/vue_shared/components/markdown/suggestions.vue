...
export default {
  ...
  methods: {
    ...
    generateDiff(suggestionIndex) {
      const { suggestions, disabled, batchSuggestionsInfo, helpPagePath, filePath, suggestionsCount } = this;
      const suggestion =
        suggestions && suggestions[suggestionIndex] ? suggestions[suggestionIndex] : {};
      const SuggestionDiffComponent = Vue.extend(SuggestionDiff);
      const suggestionDiff = new SuggestionDiffComponent({
        propsData: { disabled, suggestion, batchSuggestionsInfo, helpPagePath, filePath, suggestionsCount },
      });
