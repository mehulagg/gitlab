...
export const MSG_CANNOT_PUSH_CODE_SHOULD_FORK = s__(
  "WebIDE|You can't edit files directly in this project. Fork this project to make your changes and submit a merge request.",
);

export const MSG_CANNOT_PUSH_CODE_GO_TO_FORK = s__(
  "WebIDE|You can't edit files directly in this project. Go to your fork to make changes and submit a merge request.",
);
...
export const MSG_CANNOT_PUSH_UNSIGNED = s__(
  "WebIDE|This project does not accept unsigned commits. You can't commit your changes through the Web IDE.",
);
