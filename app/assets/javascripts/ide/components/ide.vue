...
export default {
  ...
  mounted() {
    ...
    eventHub.$on('webide-tree-rendered', this.markTreePerformance);
    eventHub.$on('webide-file-rendered', this.markEditorPerformance);
  },
  beforeCreate() {
  ...
  methods: {
    ...
    markTreePerformance() {
      this.markPerformance({
        ...
        measures: [
          {
            name: WEBIDE_MEASURE_TREE,
            start: WEBIDE_MARK_TREE_START,
    ...
    markEditorPerformance() {
      this.markPerformance({
        ...
        measures: [
          {
            name: WEBIDE_MEASURE_FILE,
            start: WEBIDE_MARK_FILE_START,
