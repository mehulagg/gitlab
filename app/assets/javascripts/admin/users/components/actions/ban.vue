...
const messageHtml = `
  <p>${s__('AdminUsers|Banning the user has the following effects:')}</p>
  <ul>
    <li>${s__('AdminUsers|User will be blocked')}</li>
    <li>${s__('AdminUsers|User can not log in')}</li>
    <li>${s__('AdminUsers|User can not access Git repositories')}</li>
  </ul>
