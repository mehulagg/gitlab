<script>
import { GlButton, GlLoadingIcon, GlIcon, GlLink, GlBadge } from '@gitlab/ui';
import SmartVirtualList from '~/vue_shared/components/smart_virtual_list.vue';
import StatusIcon from '../components/mr_widget_status_icon.vue';
...
<template>
  <section class="media-section mr-widget-border-top">
    ...
    <div v-if="!isCollapsed" class="mr-widget-grouped-section">
      <div v-if="isLoadingExpanded"><gl-loading-icon inline /> {{ __('Loading...') }}</div>
      <smart-virtual-list
        v-else
