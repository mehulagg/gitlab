...
export default {
  ...
  computed: {
    ...
    targetBranchPath() {
      if (this.glFeatures.mergeRequestWidgetGraphql) {
        return this.state.targetBranchCommitsPath;
      }

      return this.mr.targetBranchPath;
    },
    ...
    canCancelAutomaticMerge() {
      if (this.glFeatures.mergeRequestWidgetGraphql) {
        return Boolean(this.state.cancelAutoMergePath);
      }

      return this.mr.canCancelAutomaticMerge;
    },
    autoMergeStrategy() {
      ...
      <div class="media-body">
        ...
        <section class="mr-info-list">
          <p>
            ...
            <a :href="targetBranchPath" class="label-branch">{{ targetBranch }}</a>
          </p>
