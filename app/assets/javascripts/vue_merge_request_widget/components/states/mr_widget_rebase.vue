...
<template>
  <div class="mr-widget-body media">
    <template v-if="isLoading">
      <div class="gl-w-full mr-conflict-loader">
    ...
    <template v-else>
      ...
      <div class="rebase-state-find-class-convention media media-body space-children">
        <template v-if="rebaseInProgress || isMakingRequest">
          <span class="bold" data-testid="rebase-message">{{ __('Rebase in progress') }}</span>
        </template>
        <template v-if="!rebaseInProgress && !canPushToSourceBranch">
          <span class="bold" data-testid="rebase-message" v-html="fastForwardMergeText"></span>
        </template>
        <template v-if="!rebaseInProgress && canPushToSourceBranch && !isMakingRequest">
          <div
