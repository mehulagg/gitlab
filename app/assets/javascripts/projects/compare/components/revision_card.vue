...
<template>
  <gl-card class="gl-flex-basis-half" header-class="gl-py-2 gl-px-3" body-class="gl-px-3">
    <template #header>
    ...
    <div class="gl-sm-display-flex gl-align-items-center">
      <repo-dropdown class="gl-w-full gl-sm-w-half gl-sm-pr-3" :params-name="paramsName" />
      <revision-dropdown
        class="gl-w-full gl-sm-w-half gl-mt-3 gl-sm-mt-0"
