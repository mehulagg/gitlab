...
const SECONDARY_GROUP_CLASS = 'gl-mt-auto gl-border-1 gl-border-t-solid gl-border-gray-100';
    ...
    menuItemGroups() {
      return [
        { key: 'primary', items: this.primary, classes: '' },
        {
          ...
          classes: 'gl-mt-auto gl-border-1 gl-border-t-solid gl-border-gray-100',
        },
