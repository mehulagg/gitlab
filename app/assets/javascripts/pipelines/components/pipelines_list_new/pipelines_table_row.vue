...
export default {
  ...
  computed: {
    ...
    displayPipelineActions() {
      return (
        this.pipeline.retryable ||
        this.pipeline.cancelable ||
        this.pipeline.details.manual_actions.length
        // Commented out until we support artifacts via GraphQL
...
<template>
  <div class="commit gl-responsive-table-row">
    ...
    <div class="table-section section-wrap section-15 stage-cell">
      ...
      <div class="table-mobile-content">
        <template v-if="pipeline.stages.nodes.length > 0">
          <div
            v-for="(stage, index) in pipeline.stages.nodes"
            :key="index"
