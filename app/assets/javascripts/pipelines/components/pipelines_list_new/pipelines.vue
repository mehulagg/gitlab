...
import getPipelinesTable from '../../graphql/queries/get_pipelines_table.query.graphql';
      ...
      update(data) {
        ...
        pipelines.forEach(pipeline => {
          pipeline.commit = {
            ...
            short_id: 'c4029564',
            created_at: '2020-09-29T08:57:48.000-04:00',
            parent_ids: ['f093e2d6b8874b0cd1183685bdb76accd0847f0f'],
            title: 'Update .gitlab-ci.yml',
            message: 'Update .gitlab-ci.yml',
            author_name: 'Administrator',
            author_email: 'admin@example.com',
            authored_date: '2020-09-29T08:57:48.000-04:00',
            committer_name: 'Administrator',
            committer_email: 'admin@example.com',
            committed_date: '2020-09-29T08:57:48.000-04:00',
            web_url:
              'http://192.168.1.22:3000/root/parent_child/-/commit/c402956496ee23e976133755510076093fd2f3e8',
            author: {
              id: 1,
              name: 'Administrator',
              username: 'root',
            ...
            commit_url:
              'http://192.168.1.22:3000/root/parent_child/-/commit/c402956496ee23e976133755510076093fd2f3e8',
            commit_path: '/root/parent_child/-/commit/c402956496ee23e976133755510076093fd2f3e8',
          };
        });
