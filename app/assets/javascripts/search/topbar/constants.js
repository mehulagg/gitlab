...
export const ALL_SCOPE_TABS = {
  blobs: { scope: 'blobs', title: __('Code'), qa_selector: 'code_tab' },
  ...
  wiki: { scope: 'wiki_blobs', title: __('Wiki') },
  commits: { scope: 'commits', title: __('Commits') },
  epics: { scope: 'epics', title: __('Epics') },
  users: { scope: 'users', title: __('Users') },
  snippets: { scope: 'snippet_titles', title: __('Titles and Descriptions') },
  projects: { scope: 'projects', title: __('Projects'), qa_selector: 'projects_tab' },
}
