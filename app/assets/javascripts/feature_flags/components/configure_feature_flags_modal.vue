...
<template>
  ...
  >
    ...
    <gl-form-group :label="$options.translations.apiUrlLabelText" label-for="api_url">
      <gl-form-input-group id="api_url" :value="unleashApiUrl" readonly type="text" name="api_url">
        <template #append>
          <modal-copy-button
            :text="unleashApiUrl"
