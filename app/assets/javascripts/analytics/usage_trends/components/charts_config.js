    ...
    queries: [
      {
        ...
        loadError: sprintf(
          s__('UsageTrends|There was an error fetching the total pipelines'),
        ),
      },
      {
        query,
        ...
        loadError: sprintf(
          s__('UsageTrends|There was an error fetching the successful pipelines'),
        ),
      },
      {
        query,
        ...
        loadError: sprintf(
          s__('UsageTrends|There was an error fetching the failed pipelines'),
        ),
      },
      {
        query,
        ...
        loadError: sprintf(
          s__('UsageTrends|There was an error fetching the cancelled pipelines'),
        ),
      },
      {
        query,
        ...
        loadError: sprintf(
          s__('UsageTrends|There was an error fetching the skipped pipelines'),
        ),
      },
    ],
  },
  {
    ...
    queries: [
      ...
      },
      {
        ...
        loadError: sprintf(
          s__('UsageTrends|There was an error fetching the merge requests'),
        ),
      },
    ],
  },
