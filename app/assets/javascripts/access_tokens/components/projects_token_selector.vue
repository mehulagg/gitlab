...
import { convertToGraphQLIds, convertFromGraphQLIds } from '~/graphql_shared/utils';
...
export default {
  ...
  apollo: {
    projects: {
      ...
      update({ projects }) {
        return {
          list: convertFromGraphQLIds(projects.nodes),
    ...
    initialProjects: {
      ...
      result({ data: { projects } }) {
        this.$emit('input', convertFromGraphQLIds(projects.nodes));
      },
    },
  },
  data() {
