...
module Types
  class ContainerRepositoryCleanupStatusEnum < BaseEnum
    ...
    value 'UNSCHEDULED', value: 'cleanup_unscheduled', description: 'The tags cleanup is not scheduled. This the default state.'
    value 'SCHEDULED', value: 'cleanup_scheduled', description: 'The tags cleanup is scheduled and is going to be executed shortly.'
    value 'UNFINISHED', value: 'cleanup_unfinished', description: 'The tags cleanup has been partially executed. Tags to delete still remains.'
