  ...
  module Namespace
    module PackageSettings
      class Update < Mutations::BaseMutation
        ...
        argument :generic_package_duplicates_allowed,
                GraphQL::BOOLEAN_TYPE,
                required: false,
                description: copy_field_description(Types::Namespace::PackageSettingsType, :generic_package_duplicates_allowed)

        argument :generic_package_duplicate_exception_regex,
                Types::UntrustedRegexp,
                required: false,
                description: copy_field_description(Types::Namespace::PackageSettingsType, :generic_package_duplicate_exception_regex)
