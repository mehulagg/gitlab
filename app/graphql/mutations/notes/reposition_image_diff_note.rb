...
module Mutations
  module Notes
    # This mutation differs from the update mutations as it checks the
    ...
    class RepositionImageDiffNote < Mutations::Notes::Base
      ...
      # An ImageDiffNote doesn't exist as a class, but is instead
      # just a DiffNote
      ...
      def note_params(old_position, new_position)
        position = old_position.to_h.merge(new_position.to_h.compact)
