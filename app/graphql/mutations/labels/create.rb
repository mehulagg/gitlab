  ...
  module Labels
    class Create < BaseMutation
      ...
      argument :color, GraphQL::STRING_TYPE,
               ...
               description: <<~MD
                 The color of the label given in 6-digit hex notation with leading '#' sign (e.g. #FFAABB) or one of
                 the [CSS color names](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value#Color_keywords).
               MD
