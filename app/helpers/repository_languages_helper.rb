...
module RepositoryLanguagesHelper
  ...
  def language_progress(lang)
    content_tag :div, nil,
      ...
      data: { html: true },
      title: "<span class=\"repository-language-bar-tooltip-language\" itemprop=\"programmingLanguage\">#{escape_javascript(lang.name)}</span>&nbsp;<span class=\"repository-language-bar-tooltip-share\">#{lang.share.round(1)}%</span>"
  end
end
