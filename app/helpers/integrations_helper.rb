...
module IntegrationsHelper
  ...
  def teamcity_integration_event_description(event)
    ...
    when 'push', 'push_events'
      s_('TeamcityIntegration|TeamCity CI will be triggered after every push to the repository except branch delete')
    when 'merge_request', 'merge_request_events'
      s_('TeamcityIntegration|TeamCity CI will be triggered after a merge request has been created or updated')
    end
  end
