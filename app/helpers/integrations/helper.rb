...
Integrations::Helper.prepend_mod_with('Integrations::Helper')

# The methods in `EE::Integrations::Helper` should be available as both instance and
# class methods.
Integrations::Helper.extend_mod_with('Integrations::Helper')
