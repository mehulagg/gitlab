...
# AcceptsNestedAttributesDuplicatesValidator
#
...
class AcceptsNestedAttributesDuplicatesValidator < ActiveModel::EachValidator
  def validate_each(record, attribute, value)
    ...
    puts "#{self.class.name}##{__method__} record: #{record.inspect}"
    puts "#{self.class.name}##{__method__} attribute: #{attribute.inspect}"
    puts "#{self.class.name}##{__method__} value: #{value.inspect}"
    puts "#{self.class.name}##{__method__} options: #{options.inspect}"
  ...
  def validate_duplicates(record, attribute, values)
    puts "#{self.class.name}##{__method__} values: #{values.inspect}"
