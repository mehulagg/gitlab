...
class InvitesController < ApplicationController
  ...
  def authenticate_user!
    ...
    if user_sign_up?
      ...
      redirect_to new_user_session_path(sign_in_redirect_params), notice: _(sign_in_notice)
    end
  end
  ...
  def user_sign_up?
    Gitlab::CurrentSettings.allow_signup? && member && !User.by_user_email(member.invite_email).first
  end
