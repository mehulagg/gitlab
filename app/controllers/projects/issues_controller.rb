...
class Projects::IssuesController < Projects::ApplicationController
  ...
  def move
    ...
    if params[:move_to_project_id].to_i > 0
      ...
      @issue = ::Issues::UpdateService.new(container: project, current_user: current_user, params: { target_project: new_project }).execute(issue)
    end
  ...
  def update_service
    ...
    ::Issues::UpdateService.new(container: project, current_user: current_user, params: update_params)
  end
