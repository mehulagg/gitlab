...
class Projects::MergeRequestsController < Projects::MergeRequests::ApplicationController
  ...
  feature_category :code_review, [
                     ...
                     :diff_for_path, :discussions, :edit, :index, :merge, :rebase,
                     :remove_wip, :show, :toggle_award_emoji, :toggle_subscription,
                     :update
                   ]
  ...
  feature_category :release_orchestration, [:ci_environment_status]
