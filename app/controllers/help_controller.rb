...
class HelpController < ApplicationController
  ...
  def documentation_base_url
    @documentation_base_url ||= documentation_base_url_from_db || documentation_base_url_from_yml_configuration
  end
  ...
  def documentation_base_url_from_yml_configuration
    ::Gitlab.config.gitlab_docs.host if ::Gitlab.config.gitlab_docs.enabled
  end
