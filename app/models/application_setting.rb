...
class ApplicationSetting < ApplicationRecord
  ...
  validates :diff_max_files,
            presence: true,
            numericality: { only_integer: true,
                            less_than_or_equal_to: Gitlab::Git::DiffCollection::MAX_DIFF_FILES_SETTING_UPPER_BOUND }

  validates :diff_max_lines,
            presence: true,
            numericality: { only_integer: true,
                            less_than_or_equal_to: Gitlab::Git::DiffCollection::MAX_DIFF_LINES_SETTING_UPPER_BOUND }
