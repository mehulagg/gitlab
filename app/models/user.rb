...
class User < ApplicationRecord
  ...
  scope :dormant_that_can_be_deactivated, -> { active.where('last_activity_on <= ?', MINIMUM_INACTIVE_DAYS.day.ago.to_date) }
  scope :with_no_activity_that_can_be_deactivated, -> { active.where(last_activity_on: nil) }
