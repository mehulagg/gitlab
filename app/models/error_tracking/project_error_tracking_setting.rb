  ...
  class ProjectErrorTrackingSetting < ApplicationRecord
    ...
    def sentry_client
      strong_memoize(:sentry_client) do
        GitlabSentry::Client.new(api_url, token)
      end
    end
