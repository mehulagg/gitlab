...
class Issue < ApplicationRecord
  ...
  def spammable_attribute_changed?
    title_changed? ||
      description_changed? ||
      # NOTE: Confidential issues (which are therefore non-public and non-indexed) are not checked
      # for spam, but we need to check them for spam if they are made non-confidential
