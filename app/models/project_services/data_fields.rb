...
module DataFields
  ...
  included do
    has_one :issue_tracker_data, autosave: true, foreign_key: :service_id
    has_one :jira_tracker_data, autosave: true, foreign_key: :service_id
    has_one :open_project_tracker_data, autosave: true, foreign_key: :service_id
