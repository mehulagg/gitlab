  ...
  module Traversal
    module Recursive
      ...
      def self_and_hierarchy
        object_hierarchy(Namespace.where(id: id))
          .all_objects
      end
      ...
      def ancestors(hierarchy_order: nil)
        return Namespace.none unless parent_id

        object_hierarchy(Namespace.where(id: parent_id))
      ...
      def self_and_ancestors(hierarchy_order: nil)
        return Namespace.where(id: id) unless parent_id
      ...
      def descendants
        object_hierarchy(Namespace.where(parent_id: id))
