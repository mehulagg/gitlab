...
class Namespace::PackageSetting < ApplicationRecord
  ...
  validates :generic_package_duplicates_allowed, inclusion: { in: [true, false] }
  validates :generic_package_duplicate_exception_regex, untrusted_regexp: true, length: { maximum: 255 }
