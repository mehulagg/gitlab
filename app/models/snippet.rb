...
class Snippet < ApplicationRecord
  ...
  # Repositories are created by default with the `main` branch.
  # This method changes the `HEAD` file to point to the existing
  # default branch in case it's not main.
  def change_head_to_default_branch
    return unless repository.exists?
    return if default_branch == Gitlab::DefaultBranch.value(project: project)
