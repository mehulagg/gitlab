...
module Ci
  class Pipeline < Ci::ApplicationRecord
    ...
    has_many :deployments, through: :builds, disable_joins: true
    has_many :environments, -> { distinct }, through: :deployments, disable_joins: true
    ...
    scope :eager_load_project, -> { preload(project: [:route, { namespace: :route }]) }
