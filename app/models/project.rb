...
class Project < ApplicationRecord
  ...
  def dependency_proxy_variables
    Gitlab::Ci::Variables::Collection.new.tap do |variables|
      ...
      variables.append(key: 'CI_DEPENDENCY_PROXY_SERVER', value: "#{Gitlab.config.dependency_proxy.server}")
      variables.append(
        key: 'CI_DEPENDENCY_PROXY_GROUP_IMAGE_PREFIX',
        value: "#{Gitlab.config.dependency_proxy.server}#{DependencyProxy::URL_SUFFIX}"
      )
    end
  end
