...
class Service < ApplicationRecord
  ...
  def self.build_nonexistent_services_for(scope)
    nonexistent_service_types_for(scope).map do |service_type|
  ...
  private_class_method :service_name_to_type
