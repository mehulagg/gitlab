...
| Long term goals/Deciding the Sprint goal | 15 mins | Mural  | • Long term goal: Everyone spends 5 minutes in silence and write one (max 2) long term goals for the Sprint. (5 mins ) <br/> • One by one will then type them in Mural saying the long term goal aloud. (5 mins) <br/> Everyone besides the decider will vote on the goal of the Sprint (1 dot). (4 minutes) <br/> The decider then makes the final decision on the long term goal. (1 mins) |
 | Sprint questions | 20 mins | Mural | • Everyone writes down 2-3 Sprint questions for the biggest challenges they think that might stop us from achieving our long term goal. The questions should start with “Can we...” (similarly to the HMW). (7 mins) <br/> • One by one will then type them in Mural reading the Sprint questions aloud. (5 mins) <br/> • Everyone (including the decider) votes on the top 3 questions they think we should focus on as Sprint challenges (3 dots). (5 mins) <br/> • Separate the 3 most voted questions and keep them on the side. (1 min) <br/> • Finally, the decider chooses one Sprint question that will be the question we will focus on more during the Sprint. (1 min) <br/> • Write the long term goal and the Sprint questions in a dedicated Mural space, highlighting the ultimate Sprint question that the decider chose. (1 min) |
...
|  Speed critique | 5 mins | Mural | • The facilitator walks through each of the concepts, briefly summarizing each concept (to their ability) with a focus on the areas that have been dotted. <br/> • When the facilitator believes they’ve reached the end of their summary for that concept, discussion with the team if there was a concept that was voted but not discussed or the point of the red dot voting was missed in the discussion. <br/>Note:|
|  Straw Poll | ~15 mins | Mural | • All the participants besides the Decider vote (with their initials) the concept sketch they believe is the best one and will suit the challenges and goal of this sprint and is worthy of being prototyped (2 mins) <br/> • All the participants write down the reasons for choosing the concept. (5 mins) <br/> • Each participant gets 1 minute to sell their preferred concept to the Decider and the other participants. (5-10 mins) |
| Super Vote (The Decider) | 10 mins | Mural | • The Decider makes their final decision of which of the concepts is the one to move forward with. <br/> • The decider can discuss their thought process and any questions with the rest of the participants.|


### Day 3
 |  Activity  | Duration | Tool  | Description  |
|---|---|---|---|
| User test flow | 25 mins | Mural | • Each participant writes (on separate stickies) 6 steps/actions that represent a each step of a flow (you can think of a high-level prototype flow) from start to finish. Place them in a column on the User Test board. (10 mins) <br/> • Each participant takes 1 minute to walk the team through the steps one-by-one (5-10 mins). Note: It's better to have the Decider go last. <br/> • Voting: All the Sprint participants get one red dot (the Decider gets 2) to vote on the flow row they think is the best foundation for the prototype. <br/> • After everyone has voted the Decider will vote their favourite row with one dot and they can use the second dot to vote for an element of another flow they think should be incorporated in the prototype. (5 mins) <br/> • If selected, copy this sticky in the flow voted by the Decider. | 
| Storyboard | 45 mins | Mural | • Copy the winning flow from the User Test Flow exercise to the Storyboard/Prototype section. <br/> • Look at the sketch concepts and move over any relevant screens that fulfill the needs of the sticky note in that container. You can move parts of concepts. <br/> • Fill in the details that are required for each step described in the sticky. |
