...
- [ ] If it changes an existing feature that might affect end-users who are relying on the current behavior, notify to `#support_gitlab-com` and in your team channel ([more guidance when this is necessary in the dev docs](https://docs.gitlab.com/ee/development/feature_flags/controls.html#communicate-the-change)).
