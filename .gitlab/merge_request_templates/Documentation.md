...
- Technical writer review items:
  ...
  - If relevant to this MR, ensure [content topic type](https://docs.gitlab.com/ee/development/documentation/structure.html) principles are in use, including:
    ...
    - If there's content topic type work to be done and there's a need to avoid being a blocker, create a follow-on issue with the ~"docs-technical-debt" label and what needs to be done.
