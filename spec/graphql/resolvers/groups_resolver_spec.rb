...
RSpec.describe Resolvers::GroupsResolver do
  ...
  describe '#resolve' do
    ...
    let_it_be(:private_subgroup1) { create(:group, :private, parent: private_group) }
    let_it_be(:private_subgroup2) { create(:group, :private, parent: private_subgroup1) }
    ...
    shared_examples 'access to all public descendant groups' do
      it 'returns all public descendant groups of the parent group' do
