...
RSpec.describe ProtectedRef do
  ...
  with_them do
    describe '#protected_ref_accessible_to?' do
      ...
      it 'user can do action if the ref is not protected' do
      ...
      context 'the ref is protected' do
        ...
        context 'all rules permit to do action' do
        ...
        context 'one of the rules forbids to do action' do
    ...
    describe '#developers_can?' do
      ...
      it 'developers can do action if the ref is not protected' do
        is_expected.to be_truthy
      end
