      ...
      describe 'ensure_runners_registration_token!' do
        ...
        it 'persists new token as an encrypted string' do
          ...
          expect(settings.read_attribute('runners_registration_token_encrypted'))
            .to eq TokenAuthenticatableStrategies::EncryptionHelper.form_encrypted_token(subject)
    ...
    context 'token is not generated yet' do
      ...
      describe 'ensure_token!' do
        ...
        it 'persists new token as an encrypted string' do
          ...
          encrypted = TokenAuthenticatableStrategies::EncryptionHelper.form_encrypted_token(build.token)
