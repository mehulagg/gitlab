  ...
  describe '#close_issue' do
    ...
    shared_examples 'close_issue' do
      ...
      before do
        ...
        open_issue   = JIRA::Resource::Issue.new(@jira_service.client, attrs: { 'id' => issue_key, 'self' => issue_url })
      ...
      context 'when using automatic issue transitions' do
        ...
        before do
          ...
          stub_request(:get, transitions_url)
            .with(query: { expand: 'transitions.fields' })
            .to_return(body: transitions_response.to_json)
