    ...
    context 'returns variables' do
      let(:predefined_variables) do
        [
          ...
          { key: 'CI_DEPENDENCY_PROXY_SERVER', value: "#{Gitlab.config.dependency_proxy.server}", public: true, masked: false },
          { key: 'CI_DEPENDENCY_PROXY_GROUP_IMAGE_PREFIX',
            value: "#{Gitlab.config.dependency_proxy.server}/#{project.namespace.root_ancestor.path}#{DependencyProxy::URL_SUFFIX}",
            public: true,
            masked: false },
