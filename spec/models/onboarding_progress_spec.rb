...
RSpec.describe OnboardingProgress do
  ...
  describe 'scopes' do
    ...
    describe '.latest_completed_action_in_range' do
      subject { described_class.latest_completed_action_in_range(actions, 1.day.ago.beginning_of_day..1.day.ago.end_of_day) }
