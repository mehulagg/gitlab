...
RSpec.describe Group do
  ...
  describe '#avatar_type' do
    ...
    it "is false if avatar is html page" do
      ...
      expect(group.errors.values.first).to eq("file format is not supported. Please try one of the following supported formats: png, jpg, jpeg, gif, bmp, tiff, ico, webp")
    end
  end
