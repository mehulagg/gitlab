...
RSpec.describe 'cadences routing' do
  ...
  it "routes to list iterations within cadence" do
    expect(get("/groups/#{group_path}/-/cadences/1/iterations")).to route_to('groups/iteration_cadences#index', group_id: group_path, "vueroute"=>"1/iterations")
  end

  it "routes to show iteration within cadence" do
    expect(get("/groups/#{group_path}/-/cadences/1/iterations/1")).to route_to('groups/iteration_cadences#index', group_id: group_path, "vueroute"=>"1/iterations/1")
  end

  it "routes to new iteration within cadence" do
    expect(get("/groups/#{group_path}/-/cadences/1/iterations/1/new")).to route_to('groups/iteration_cadences#index', group_id: group_path, "vueroute"=>"1/iterations/1/new")
  end

  it "routes to edit iteration within cadence" do
    expect(get("/groups/#{group_path}/-/cadences/1/iterations/1/edit")).to route_to('groups/iteration_cadences#index', group_id: group_path, "vueroute"=>"1/iterations/1/edit")
  end
end
