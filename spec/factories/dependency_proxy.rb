...
FactoryBot.define do
  factory :dependency_proxy_blob, class: 'DependencyProxy::Blob' do
    group
    file { Rack::Test::UploadedFile.new('spec/fixtures/dependency_proxy/a3ed95caeb02ffe68cdd9fd84406680ae93d633cb16422d00e8a7c22955b46d4.gz') }
  ...
  factory :dependency_proxy_manifest, class: 'DependencyProxy::Manifest' do
    group
    file { Rack::Test::UploadedFile.new('spec/fixtures/dependency_proxy/manifest') }
