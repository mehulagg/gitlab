...
RSpec.describe ReleaseHighlights::Validator::Entry do
  ...
  describe 'validations' do
    ...
    context 'with a blank entry' do
      ...
      it 'validates URI of "url" and "image_url"', :stub_invalid_dns_only do
        stub_env('RSPEC_ALLOW_INVALID_URLS', 'false')
        allow(entry).to receive(:value_for).with(:image_url).and_return('https://about.gitlabcom/images/ci/gitlab-ci-cd-logo_2x.png')
