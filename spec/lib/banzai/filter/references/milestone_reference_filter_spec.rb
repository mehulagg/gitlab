...
#       #   act = <<~MD
#       #     See #{project.full_path}%#{milestone.iid}
#       #
#       #     #{project.full_path}%9999
#       #   MD
#       #   control = ActiveRecord::QueryRecorder.new { reference_filter(act) }
#       #
#       #   act = "Hey #{get_reference(user)} and @someone"
#       #
#       #   expect { reference_filter(act) }.not_to exceed_query_limit(control)
#       # end
#     end
#
