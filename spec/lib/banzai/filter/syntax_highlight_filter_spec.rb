...
RSpec.describe Banzai::Filter::SyntaxHighlightFilter do
  ...
  context "when no language is specified" do
    it "highlights as plaintext" do
      ...
      expect(result.to_html).to eq('<pre class="code highlight js-syntax-highlight plaintext" lang="plaintext" v-pre="true"><code><div id="LC1" class="line" lang="plaintext">def fun end</div></code></pre>')
    end
  ...
  context "when a valid language is specified" do
    it "highlights as that language" do
      ...
      expect(result.to_html).to eq('<pre class="code highlight js-syntax-highlight ruby" lang="ruby" v-pre="true"><code><div id="LC1" class="line" lang="ruby"><span class="k">def</span> <span class="nf">fun</span> <span class="k">end</span></div></code></pre>')
    end
  ...
  context "when an invalid language is specified" do
    it "highlights as plaintext" do
      ...
      expect(result.to_html).to eq('<pre class="code highlight js-syntax-highlight plaintext" lang="plaintext" v-pre="true"><code><div id="LC1" class="line" lang="plaintext">This is a test</div></code></pre>')
    end
  ...
  context "languages that should be passed through" do
    ...
    %w(math mermaid plantuml suggestion).each do |lang|
      context "when #{lang} is specified" do
        it "highlights as plaintext but with the correct language attribute and class" do
          ...
          expect(result.to_html).to eq(%{<pre class="code highlight js-syntax-highlight #{lang}" lang="#{lang}" v-pre="true"><code><div id="LC1" class="line" lang="#{lang}">This is a test</div></code></pre>})
        end
      ...
      context "when #{lang} has extra params" do
        ...
        it "includes data-lang-params tag with extra information" do
          ...
          expect(result.to_html).to eq(%{<pre class="code highlight js-syntax-highlight #{lang}" lang="#{lang}" #{data_attr}="#{lang_params}" v-pre="true"><code><div id="LC1" class="line" lang="#{lang}">This is a test</div></code></pre>})
        end
    ...
    context 'when multiple param delimiters are used' do
      ...
      it "delimits on the first appearance" do
        ...
        expect(result.to_html).to eq(%{<pre class="code highlight js-syntax-highlight #{lang}" lang="#{lang}" #{data_attr}="#{lang_params}#{delimiter}more-things" v-pre="true"><code><div id="LC1" class="line" lang="#{lang}">This is a test</div></code></pre>})
      end
    end
  end
  ...
  context "when Rouge lexing fails" do
    ...
    it "highlights as plaintext" do
      ...
      expect(result.to_html).to eq('<pre class="code highlight js-syntax-highlight" lang="" v-pre="true"><code><div id="LC1" class="line" lang="">This is a test</div></code></pre>')
    end
