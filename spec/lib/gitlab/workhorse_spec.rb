...
RSpec.describe Gitlab::Workhorse do
  ...
  before do
    stub_feature_flags(gitaly_deny_disk_access: true)
  end
  ...
  describe ".send_git_archive" do
    ...
    it 'sets the header correctly' do
      ...
      expect(params).to eq({
        'GitalyServer' => {
          features: { 'gitaly-feature-deny-disk-access' => 'true' },
      ...
      context "when git_upload_pack action is passed" do
        ...
        context 'when a feature flag is set for a single project' do
          ...
          it 'sets the flag to true for that project' do
            ...
            expect(response.dig(:GitalyServer, :features)).to eq('gitaly-feature-deny-disk-access' => 'true',
