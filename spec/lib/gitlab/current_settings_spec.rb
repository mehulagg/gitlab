...
RSpec.describe Gitlab::CurrentSettings do
  ...
  describe '.pick_repository_storage', :request_store do
    before do
      storages = {
    ...
    context 'when expire is false' do
      it 'does not expire existing repository storage value' do
        previous_storage = described_class.pick_repository_storage
        ...
        new_storage = described_class.pick_repository_storage(expire: false)
    ...
    context 'when expire is true' do
      it 'expires existing repository storage value' do
        ...
        new_storage = described_class.pick_repository_storage(expire: true)
