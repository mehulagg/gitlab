...
RSpec.describe Gitlab::UsageData, :aggregate_failures do
  ...
  describe '.aggregated_metrics_weekly' do
    ...
    it 'uses ::Gitlab::ProductIntelligence::AggregatedMetrics::Aggregate#weekly_data', :aggregate_failures do
      expect_next_instance_of(::Gitlab::ProductIntelligence::AggregatedMetrics::Aggregate) do |instance|
  ...
  describe '.aggregated_metrics_monthly' do
    ...
    it 'uses ::Gitlab::ProductIntelligence::AggregatedMetrics::Aggregate#monthly_data', :aggregate_failures do
      expect_next_instance_of(::Gitlab::ProductIntelligence::AggregatedMetrics::Aggregate) do |instance|
