      ...
      context "XSS" do
        items = {
          ...
          'fenced code with inline script' => {
            ...
            output: "<div>\n<div>\n<pre class=\"code highlight js-syntax-highlight plaintext\" lang=\"plaintext\" v-pre=\"true\"><code><div id=\"LC1\" class=\"line\" lang=\"plaintext\">\"&gt;</div></code></pre>\n</div>\n</div>"
          }
        }
      ...
      context 'with fenced block' do
        it 'highlights syntax' do
          ...
          output = <<~HTML
            <div>
            <div>
            <pre class="code highlight js-syntax-highlight javascript" lang="javascript" v-pre="true"><code><div id="LC1" class="line" lang="javascript"><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="dl">'</span><span class="s1">hello world</span><span class="dl">'</span><span class="p">)</span></div></code></pre>
            </div>
            </div>
          HTML
      ...
      context 'with listing block' do
        it 'highlights syntax' do
          ...
          output = <<~HTML
            ...
            <div>class.cpp</div>
            <div>
            <pre class="code highlight js-syntax-highlight cpp" lang="cpp" v-pre="true"><code><div id="LC1" class="line" lang="cpp"><span class="cp">#include &lt;stdio.h&gt;</span></div>
            <div id="LC2" class="line" lang="cpp"></div>
            <div id="LC3" class="line" lang="cpp"><span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="mi">5</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span> <span class="p">{</span></div>
            <div id="LC4" class="line" lang="cpp">  <span class="n">std</span><span class="o">::</span><span class="n">cout</span><span class="o">&lt;&lt;</span><span class="s">"*"</span><span class="o">&lt;&lt;</span><span class="n">std</span><span class="o">::</span><span class="n">endl</span><span class="p">;</span></div>
            <div id="LC5" class="line" lang="cpp"><span class="p">}</span></div></code></pre>
            </div>
            </div>
          HTML
