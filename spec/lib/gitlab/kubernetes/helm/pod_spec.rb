...
RSpec.describe Gitlab::Kubernetes::Helm::Pod do
  describe '#generate' do
    ...
    where(:helm_major_version, :helm_version) do
      2 | '2.16.9'
      3 | '3.2.4'
    end
    ...
    with_them do
      ...
      context 'with a command' do
        ...
        it 'generates the appropriate specifications for the container' do
          ...
          expect(container.image).to eq("registry.gitlab.com/gitlab-org/cluster-integration/helm-install-image/releases/#{helm_version}-kube-1.13.12-alpine-3.12")
