...
require 'gitlab/danger/reviewers/weighted_reviewers'

RSpec.describe Gitlab::Danger::Reviewers::WeightedReviewers do
  ...
  let(:hungry_reviewer_count) { Gitlab::Danger::Reviewers::REVIEWER_WEIGHT * described_class::HUNGRY_WEIGHT * multiplier }
  let(:hungry_traintainer_count) { described_class::TRAINTAINER_WEIGHT * multiplier * described_class::HUNGRY_WEIGHT }
  let(:reviewer_count) { Gitlab::Danger::Reviewers::REVIEWER_WEIGHT * multiplier }
  let(:traintainer_count) { Gitlab::Danger::Reviewers::REVIEWER_WEIGHT * described_class::TRAINTAINER_WEIGHT * multiplier }
  let(:reduced_capacity_reviewer_count) { Gitlab::Danger::Reviewers::REVIEWER_WEIGHT }
