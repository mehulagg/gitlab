...
RSpec.describe Gitlab::ImportExport::RepoRestorer do
  ...
  describe 'bundle a project Git repo' do
    ...
    subject { described_class.new(path_to_bundle: bundle_path, shared: shared, exportable: project) }
  ...
  describe 'restore a wiki Git repo' do
    ...
    subject { described_class.new(path_to_bundle: bundle_path, shared: shared, exportable: ProjectWiki.new(project)) }
