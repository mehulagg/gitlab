...
RSpec.describe Gitlab::Usage::Metrics::Instrumentations::CountUsersVisitingAnalyticsValuestreamMetric, :clean_gitlab_redis_shared_state do
  before do
    ...
    Gitlab::UsageDataCounters::HLLRedisCounter.track_event(:g_analytics_valuestream, values: 1, time: 2.weeks.ago)
    Gitlab::UsageDataCounters::HLLRedisCounter.track_event(:g_analytics_valuestream, values: 2, time: 2.weeks.ago)
    Gitlab::UsageDataCounters::HLLRedisCounter.track_event(:g_analytics_valuestream, values: 2, time: 2.months.ago)
  end
