...
RSpec.describe Gitlab::Ci::Build::Releaser do
  ...
  describe '#script' do
      ...
      let(:config) do
        {
          release: {
            ...
            assets: [
                ...
                { name: 'asset2', url: 'https://example.com/assets/2', link_type: 'other', filepath: '/pretty/asset/2' }
            ]
          }
        }
      end
    ...
    context 'individual nodes' do
      ...
      asset = { name: 'asset1', url: 'https://example.com/assets/1', link_type: 'other', filepath: '/pretty/asset/1' }
      ...
      where(:node_name, :node_value, :result) do
        ...
        :assets      | [asset]                          | "release-cli create --assets-link #{asset.to_json}"
      end
