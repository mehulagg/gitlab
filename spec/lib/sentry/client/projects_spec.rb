...
RSpec.describe GitlabSentry::Client::Projects do
  ...
  describe '#projects' do
    ...
    context 'essential keys missing in API response' do
      ...
      it 'raises exception' do
        expect { subject }.to raise_error(GitlabSentry::Client::MissingKeysError, 'Sentry API response is missing keys. key not found: "slug"')
      end
    end
