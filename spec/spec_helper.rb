      ...
      class RSpecAdapter < BaseAdapter
        def bind_time_tracker
          ::RSpec.configure do |config|
            # Original version is `config.prepend_before(:each) do`: https://github.com/KnapsackPro/knapsack/blob/v1.17.0/lib/knapsack/adapters/rspec_adapter.rb#L9
            ...
            # Original version is `config.append_after(:each) do`: https://github.com/KnapsackPro/knapsack/blob/v1.17.0/lib/knapsack/adapters/rspec_adapter.rb#L20
