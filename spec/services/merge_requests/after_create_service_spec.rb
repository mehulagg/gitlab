...
RSpec.describe MergeRequests::AfterCreateService do
  ...
  subject(:after_create_service) do
    described_class.new(container: merge_request.target_project, current_user: merge_request.author)
  end
  ...
  describe '#execute' do
    ...
    it 'calls MergeRequests::LinkLfsObjectsService#execute' do
      ...
      allow(MergeRequests::LinkLfsObjectsService).to receive(:new).with(container: merge_request.target_project).and_return(service)
