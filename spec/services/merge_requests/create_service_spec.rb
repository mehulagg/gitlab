  ...
  describe '#execute' do
    ...
    context 'Quick actions' do
      context 'with assignee and milestone in params and command' do
        let(:merge_request) { described_class.new(container: project, current_user: user, params: opts).execute }
        let(:milestone) { create(:milestone, project: project) }
    ...
    context 'merge request create service' do
      context 'asssignee_id' do
        ...
        it 'removes assignee_id when user id is invalid' do
          ...
          merge_request = described_class.new(container: project, current_user: user, params: opts).execute
    ...
    context 'when source and target projects are different' do
      ...
      context 'when user can not access source project' do
        ...
        it 'raises an error' do
          expect { described_class.new(container: project, current_user: user, params: opts).execute }
