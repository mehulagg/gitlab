    ...
    context 'clone an issue' do
      context 'valid project' do
        ...
        it 'calls the move service with the proper issue and project' do
          ...
          allow(clone_stub).to receive(:execute).with(issue, target_project, with_comments: nil).and_return(issue)

          expect(clone_stub).to receive(:execute).with(issue, target_project, with_comments: nil)
