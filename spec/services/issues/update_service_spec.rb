  ...
  describe 'execute' do
    ...
    context 'valid params' do
      ...
      context 'when issue type is not incident' do
        ...
        it_behaves_like 'does not track incident management event' do
      ...
      context 'when issue type is incident' do
        ...
        it_behaves_like 'an incident management tracked event', :incident_management_incident_change_confidential do
      ...
      context 'on incidents' do
        ...
        context 'with severity value defined but unchanged' do
          ...
          it 'does not trigger side-effects' do
            ...
            update_issue(severity: issue.severity)
          end
        end
      end
