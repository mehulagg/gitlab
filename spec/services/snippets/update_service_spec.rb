  ...
  describe '#execute', :aggregate_failures do
    ...
    shared_examples 'creates repository and creates file' do
      context 'when file_name and content params are used' do
        ...
        it 'commits the files to the repository' do
          ...
          blob = snippet.repository.blob_at(project.default_branch, options[:file_name])
      ...
      context 'when snippet_actions param is used' do
        ...
        it 'performs operation without raising errors' do
          ...
          new_blob = snippet.repository.blob_at(project.default_branch, file_path)
          created_file = snippet.repository.blob_at(project.default_branch, created_file_path)
    ...
    shared_examples 'when snippet_actions param is present' do
      ...
      context 'commit actions' do
        ...
        def blob(path)
          snippet.repository.blob_at(project.default_branch, path)
        end
      end
    end
    ...
    shared_examples 'only file_name is present' do
      ...
      shared_examples 'content is not updated' do
        specify do
          ...
          blob = snippet.repository.blob_at(project.default_branch, file_name)
    ...
    shared_examples 'only content is present' do
      ...
      it 'updates the content' do
        ...
        blob = snippet.repository.blob_at(project.default_branch, snippet.blobs.first.path)
