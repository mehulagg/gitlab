...
RSpec.describe SubmitUsagePingService do
  ...
  shared_examples 'does not run' do
    it do
      ...
      expect(Gitlab::Usage::UsageDataInstrumentation).not_to receive(:data)
  ...
  context 'when usage ping is enabled' do
    ...
    it 'forces a refresh of usage data statistics before submitting' do
      ...
      expect(Gitlab::Usage::UsageDataInstrumentation).to receive(:data).with(force_refresh: true).and_call_original
    ...
    context 'when conv_index data is passed' do
      ...
      it 'saves usage_data_id to version_usage_data_id_value' do
        ...
        expect(Gitlab::Usage::UsageDataInstrumentation).to receive(:data).with(force_refresh: true).and_return(usage_data)
