...
RSpec.describe Suggestions::CreateService do
  ...
  shared_examples_for 'service not tracking suggestion added event' do
    it 'does not track suggestion added event' do
      expect(Gitlab::UsageDataCounters::MergeRequestActivityUniqueCounter)
        .not_to receive(:track_suggestion_added_action)
  ...
  describe '#execute' do
    context 'should not try to parse suggestions' do
      context 'when not a diff note for merge requests' do
        ...
        it_behaves_like 'service not tracking suggestion added event'
      end
    ...
    context 'should create suggestions' do
      ...
      it 'tracks suggestion added event' do
        expect(Gitlab::UsageDataCounters::MergeRequestActivityUniqueCounter)
          .to receive(:track_suggestion_added_action)
