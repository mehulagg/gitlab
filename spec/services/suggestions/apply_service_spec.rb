...
RSpec.describe Suggestions::ApplyService do
  ...
  shared_examples 'successfully creates commit and updates suggestions' do
    ...
    it 'tracks suggestion apply event' do
      expect(Gitlab::UsageDataCounters::MergeRequestActivityUniqueCounter)
        .to receive(:track_suggestion_apply_action)
        .with(user: user)
  ...
  context 'patch is not appliable' do
    ...
    shared_examples_for 'service not tracking suggestion apply event' do
      it 'does not track suggestion apply event' do
        expect(Gitlab::UsageDataCounters::MergeRequestActivityUniqueCounter)
          .not_to receive(:track_suggestion_apply_action)
    ...
    context 'diff file was not found' do
      ...
      it_behaves_like 'service not tracking suggestion apply event'
    end
