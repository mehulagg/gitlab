...
RSpec.describe ::Ci::PipelineArtifacts::QualityReportService do
  describe '#execute' do
    ...
    context 'when pipeline has codequality reports' do
      ...
      context 'when pipeline is finished' do
        it 'creates a pipeline artifact' do
          expect { pipeline_artifact }.to change(Ci::PipelineArtifact, :count).by(1)
        end
    ...
    context 'when pipeline is running and codequality report does not exist' do
