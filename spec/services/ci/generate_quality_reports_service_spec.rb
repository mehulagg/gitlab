...
RSpec.describe Ci::GenerateQualityReportsService do
  ...
  describe '#execute' do
    ...
    context 'when head pipeline does not have a quality report artifact' do
      ...
      it 'returns status and error message' do
        ...
        expect(subject[:status_reason]).to include('An error occurred while fetching quality reports.')
      end
    end

    context 'when head pipeline has quality reports and no merge request associated' do
