  ...
  describe '#execute' do
    ...
    context 'when alert payload is valid' do
      ...
      context 'with resolving payload' do
        ...
        # Change to 'processes recovery alert' in https://gitlab.com/gitlab-org/gitlab/-/merge_requests/57302
        # Remove 'processes prometheus recovery alert' shared example
