    ...
    context 'with HTTP integration' do
      ...
      context 'with valid token' do
        ...
        context 'with valid payload' do
          ...
          let(:source) { payload_raw.fetch(:monitoring_tool) }
          ...
          context 'with partial payload' do
            ...
            it_behaves_like 'never-before-seen alert'
            ...
            context 'with existing alert with matching payload' do
              let(:gitlab_fingerprint) { Gitlab::AlertManagement::Fingerprint.generate(payload.except(:start_time)) }
              let!(:alert) { create(:alert_management_alert, project: project, fingerprint: gitlab_fingerprint) }
        ...
        context 'with inactive integration' do
          ...
          it_behaves_like 'alerts service responds with an error', :forbidden
        end
      end
