...
RSpec.describe 'Every Sidekiq worker' do
  ...
  context 'retries' do
    let(:retry_exception_workers) do
      workers_without_defaults.select { |worker| retry_exceptions.has_key?(worker.klass) }
    end

    let(:retry_exceptions) do
      {
        ActiveUserCountThresholdWorker => false,
        AdjournedGroupDeletionWorker => false,
        AdjournedProjectDeletionWorker => 3,
        AdjournedProjectsDeletionCronWorker => false,
        AdminEmailWorker => false,
        AdminEmailsWorker => 3,
        Analytics::CodeReviewMetricsWorker => 3,
        Analytics::DevopsAdoption::CreateAllSnapshotsWorker => false,
        Analytics::DevopsAdoption::CreateSnapshotWorker => 3,
        Analytics::InstanceStatistics::CountJobTriggerWorker => false,
        Analytics::InstanceStatistics::CounterJobWorker => 3,
        Analytics::UsageTrends::CountJobTriggerWorker => false,
        ...
        AuthorizedProjectUpdate::PeriodicRecalculateWorker => false,
        ...
        Ci::ArchiveTracesCronWorker => false,
        ...
        Ci::PipelineArtifacts::ExpireArtifactsWorker => false,
        ...
        Ci::ScheduleDeleteObjectsCronWorker => false,
        Ci::TestFailureHistoryWorker => 3,
        Ci::TriggerDownstreamSubscriptionsWorker => 3,
        CiPlatformMetricsUpdateCronWorker => false,
        CleanupContainerRepositoryWorker => 3,
        ClearSharedRunnersMinutesWorker => false,
        ...
        Clusters::Applications::CheckPrometheusHealthWorker => false,
        ...
        ContainerExpirationPolicyWorker => false,
        ...
        Database::BatchedBackgroundMigrationWorker => false,
        ...
        ExpireBuildArtifactsWorker => false,
        ...
        Geo::MetricsUpdateWorker => false,
        Geo::ProjectSyncWorker => 3,
        Geo::PruneEventLogWorker => false,
        Geo::RegistrySyncWorker => false,
        ...
        Geo::RepositorySyncWorker => false,
        Geo::RepositoryVerification::Primary::BatchWorker => false,
        Geo::RepositoryVerification::Primary::ShardWorker => false,
        Geo::RepositoryVerification::Primary::SingleWorker => false,
        Geo::RepositoryVerification::Secondary::SchedulerWorker => false,
        Geo::RepositoryVerification::Secondary::ShardWorker => false,
        Geo::RepositoryVerification::Secondary::SingleWorker => false,
        Geo::ReverificationBatchWorker => 0,
        Geo::Scheduler::PerShardSchedulerWorker => false,
        Geo::Scheduler::Primary::PerShardSchedulerWorker => false,
        Geo::Scheduler::Primary::SchedulerWorker => 3,
        Geo::Scheduler::SchedulerWorker => 3,
        Geo::Scheduler::Secondary::PerShardSchedulerWorker => false,
        Geo::Scheduler::Secondary::SchedulerWorker => 3,
        Geo::Secondary::RegistryConsistencyWorker => false,
        Geo::SecondaryUsageDataCronWorker => false,
        Geo::SidekiqCronConfigWorker => false,
        Geo::SyncTimeoutCronWorker => false,
        Geo::VerificationBatchWorker => 0,
        Geo::VerificationCronWorker => false,
        ...
        Gitlab::Import::StuckProjectImportJobsWorker => false,
        ...
        Gitlab::JiraImport::StuckJiraImportJobsWorker => false,
        ...
        HistoricalDataWorker => false,
        ImportExportProjectCleanupWorker => false,
        ...
        IncidentManagement::IncidentSlaExceededCheckWorker => false,
        ...
        IngressModsecurityCounterMetricsWorker => false,
        InvalidGpgSignatureUpdateWorker => 3,
        IrkerWorker => 3,
        IssuableExportCsvWorker => 3,
        IssueDueSchedulerWorker => false,
        ...
        Namespaces::PruneAggregationSchedulesWorker => false,
        ...
        Packages::Composer::CacheCleanupWorker => false,
        ...
        PagesDomainRemovalCronWorker => false,
        PagesDomainSslRenewalCronWorker => false,
        PagesDomainSslRenewalWorker => 3,
        PagesDomainVerificationCronWorker => false,
        PagesDomainVerificationWorker => 3,
        PagesRemoveWorker => 3,
        PagesTransferWorker => 3,
        PagesUpdateConfigurationWorker => 3,
        PagesWorker => 3,
        PartitionCreationWorker => false,
        PersonalAccessTokens::ExpiredNotificationWorker => false,
        PersonalAccessTokens::ExpiringWorker => false,
        ...
        PruneOldEventsWorker => false,
        PruneWebHookLogsWorker => false,
        PseudonymizerWorker => false,
        ...
        Releases::ManageEvidenceWorker => false,
        RemoteMirrorNotificationWorker => 3,
        RemoveExpiredGroupLinksWorker => false,
        RemoveExpiredMembersWorker => false,
        RemoveUnacceptedMemberInvitesWorker => false,
        RemoveUnreferencedLfsObjectsWorker => false,
        RepositoryArchiveCacheWorker => false,
        RepositoryCheck::BatchWorker => false,
        RepositoryCheck::ClearWorker => false,
        RepositoryCheck::DispatchWorker => false,
        ...
        ScheduleMergeRequestCleanupRefsWorker => false,
        ScheduleMigrateExternalDiffsWorker => false,
        ...
        SshKeys::ExpiredNotificationWorker => false,
        SshKeys::ExpiringSoonNotificationWorker => false,
        StageUpdateWorker => 3,
        StatusPage::PublishWorker => 5,
        StoreSecurityReportsWorker => 3,
        StoreSecurityScansWorker => 3,
        StuckCiJobsWorker => false,
        StuckExportJobsWorker => false,
        StuckMergeJobsWorker => false,
        ...
        TrendingProjectsWorker => false,
        UpdateAllMirrorsWorker => false,
        UpdateContainerRegistryInfoWorker => false,
        UpdateExternalPullRequestsWorker => 3,
        UpdateHeadPipelineForMergeRequestWorker => 3,
        UpdateHighestRoleWorker => 3,
        UpdateMaxSeatsUsedForGitlabComSubscriptionsWorker => false,
        UpdateMergeRequestsWorker => 3,
        UpdateProjectStatisticsWorker => 3,
        UploadChecksumWorker => 3,
        UserStatusCleanup::BatchWorker => false,
        Users::CreateStatisticsWorker => false,
        Vulnerabilities::HistoricalStatistics::DeletionWorker => false,
        Vulnerabilities::Statistics::AdjustmentWorker => 3,
        Vulnerabilities::Statistics::ScheduleWorker => false,
        ...
        X509IssuerCrlCheckWorker => false
      }
    end

    it 'uses 25 retries for new jobs' do
      expect(workers_without_defaults - retry_exception_workers).to all(have_attributes(retries: 25))
    end
    ...
    it 'uses specified numbers of retries for workers with exceptions encoded here', :aggregate_failures do
      retry_exception_workers.each do |worker|
        expect(worker.retries).to eq(retry_exceptions[worker.klass]), "#{worker.klass} has #{worker.retries} retries, expected #{retry_exceptions[worker.klass]}"
      end
    end
  end
end
