...
RSpec.describe 'Set up instance Mattermost slash commands', :js do
  describe 'user visits the mattermost slash command config page' do
    ...
    it 'redirects to the integrations page after activating' do
      ...
      expect(current_path).to eq(edit_admin_application_settings_integration_path(:mattermost_slash_commands))
