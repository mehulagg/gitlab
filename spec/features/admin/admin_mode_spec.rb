...
RSpec.describe 'Admin mode' do
  ...
  context 'application setting :admin_mode is enabled', :request_store do
    ...
    context 'when in admin_mode' do
      ...
      it 'can leave admin mode using top nav on smaller screens', :js do
        resize_screen_xs
        visit root_dashboard_path

        find('[data-testid="top-nav-responsive-toggle"]').clicka
      ...
      context 'nav bar' do
        ...
        it 'relocates admin dashboard links to dropdown list on smaller screen', :js do
          ...
          find('[data-testid="top-nav-responsive-toggle"]').click
