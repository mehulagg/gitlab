...
RSpec.shared_examples 'processes never-before-seen recovery alert' do
  ...
  xit 'after https://gitlab.com/gitlab-org/gitlab/-/merge_requests/57302' do
    # Additional system notes will be created after alert is auto-resolved.
    # Incidents will not be created for self-resolving alerts.
    # Alerts will have a status change to resolved.
    it_behaves_like 'creates an alert management alert or errors'
...
RSpec.shared_examples 'processes one firing and one resolved prometheus alerts' do
  it 'creates AlertManagement::Alert' do
    ...
    expect { subject }
      # Change 1 -> 2 in https://gitlab.com/gitlab-org/gitlab/-/merge_requests/57302
      # Additional alert will be created, then immediately auto-resolved.
      .to change(AlertManagement::Alert, :count).by(1)
      # Change 1 -> 4 in https://gitlab.com/gitlab-org/gitlab/-/merge_requests/57302
      # Additional system notes will be created after alert is auto-resolved.
  ...
  # Change 1 -> 2 in https://gitlab.com/gitlab-org/gitlab/-/merge_requests/57302
  # Additional resolved alert email notification will be sent for self-resolved alert.
