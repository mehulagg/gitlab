  ...
  describe 'scopes' do
    ...
    describe '.with_codename_or_suite' do
      describe 'passing codename' do
        ...
        it 'does not return other distributions' do
          expect(subject.to_a).to match_array([distribution_with_suite, distribution_with_same_codename, distribution_with_codename_and_suite_flipped])
        end
      end
      ...
      describe 'passing suite' do
        ...
        it 'does not return other distributions' do
          expect(subject.to_a).to match_array([distribution_with_suite, distribution_with_same_suite, distribution_with_codename_and_suite_flipped])
        end
      end
    end
  end
