...
module AccessMatchersHelpers
  ...
  def patch_example_group(user)
    ...
    if RSpec.current_example.attempts > 0
      instance_eval(<<~CODE, __FILE__, __LINE__ + 1)
        instance_variable_set(:@__#{USER_ACCESSOR_METHOD_NAME}_patched, false)
        instance_variable_set(:@#{USER_ACCESSOR_METHOD_NAME}, nil)
        undef #{USER_ACCESSOR_METHOD_NAME}
      CODE
    end
