...
RSpec.describe SchedulePopulateHasVulnerabilities do
  ...
  before do
    ...
    vulnerabilities.create!(vulnerability_base_params.merge(project_id: project_2.id))
  end
  ...
  it 'schedules the background jobs', :aggregate_failures do
    ...
    expect(described_class::MIGRATION_CLASS).to be_scheduled_delayed_migration(1.minute, project_1.id)
    expect(described_class::MIGRATION_CLASS).to be_scheduled_delayed_migration(2.minutes, project_2.id)
  end
end
