...
require 'spec_helper'
require Rails.root.join('db', 'post_migrate', '20210514063252_cleanup_orphaned_lfs_objects_projects.rb')

RSpec.describe CleanupOrphanedLfsObjectsProjects, :sidekiq, schema: 20210511165250 do
