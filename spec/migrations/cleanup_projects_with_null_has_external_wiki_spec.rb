...
RSpec.describe CleanupProjectsWithNullHasExternalWiki, :migration do
  ...
  after do
    # Revert DB structure
    ActiveRecord::Base.connection.execute "ALTER TABLE projects ADD CONSTRAINT #{constraint_name} CHECK ((has_external_wiki IS NOT NULL)) NOT VALID;"
  end
