...
RSpec.describe ScheduleRecalculateUuidOnVulnerabilitiesOccurrences, :migration do
  ...
  it 'schedules background migration' do
    ...
    expect(described_class::MIGRATION).to be_scheduled_migration([finding_with_uuid_v4.id])
    expect(described_class::MIGRATION).to be_scheduled_migration([finding_with_uuid_v5.id])
  end
