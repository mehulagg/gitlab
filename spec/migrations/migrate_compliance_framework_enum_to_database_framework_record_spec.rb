...
RSpec.describe MigrateComplianceFrameworkEnumToDatabaseFrameworkRecord, schema: 20201005092753 do
  ...
  it 'updates the project settings' do
    ...
    gdpr_framework = compliance_management_frameworks.find_by(group_id: root_group.id, name: 'GDPR')
    ...
    sox_framework = compliance_management_frameworks.find_by(group_id: root_group.id, name: 'SOX')
  ...
  it 'adds two framework records' do
    ...
    expect(compliance_management_frameworks.count).to eq(2)
  end
end
