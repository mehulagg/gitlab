    ...
    Sidekiq::Testing.fake! do
      ...
      freeze_time do
        ...
        expect(described_class::MIGRATION)
          .to be_scheduled_delayed_migration(2.minutes, draft_mrs.first.id, draft_mrs.first.id)
        expect(described_class::MIGRATION)
          .to be_scheduled_delayed_migration(4.minutes, draft_mrs.second.id, draft_mrs.second.id)
