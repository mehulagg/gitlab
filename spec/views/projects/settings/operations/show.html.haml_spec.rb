  ...
  describe 'Operations > Prometheus' do
    ...
    context 'when settings_operations_prometheus_service is disabled' do
      ...
      it 'renders the Operations Settings page' do
        ...
        expect(rendered).not_to have_content _('Select the Active checkbox to override the Auto configuration with custom settings. To use the Auto configuration settings, deselect the checkbox.')
      end
    end
  end
