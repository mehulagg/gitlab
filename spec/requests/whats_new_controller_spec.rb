    ...
    context 'with whats_new_drawer feature enabled' do
      ...
      context 'with no page param' do
        ...
        it 'responds with paginated data and headers' do
          allow(ReleaseHighlight).to receive(:most_recent).with(page: 1).and_return(most_recent)
      ...
      context 'with page param' do
        it 'passes the page parameter' do
          expect(ReleaseHighlight).to receive(:most_recent).with(page: 2).and_call_original
