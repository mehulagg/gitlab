  ...
  describe 'GET /links' do
    ...
    context 'when authenticated' do
      ...
      it 'accepts pagination params' do
        perform_request(user, { per_page: 1 })
      ...
      context 'when paginate_issue_links is disabled' do
        before do
          stub_feature_flags(paginate_issue_links: false)
        end

        it 'does take pagination params into account' do
          perform_request(user, { per_page: 1 })
      ...
      it 'returns multiple links without N + 1' do
        ...
        expect { perform_request(user) }.not_to exceed_query_limit(control_count + 2)
      end
    end
  end
