      ...
      context 'when valid token is provided' do
        ...
        context 'when project token is used' do
          ...
          context 'when abandoned runners cause application limits to not be exceeded' do
            before do
              create(:ci_runner, runner_type: :project_type, projects: [project], contacted_at: 10.seconds.ago)
              create(:ci_runner, runner_type: :project_type, projects: [project], contacted_at: 13.months.ago)
              create(:plan_limits, :default_plan, ci_registered_project_runners: 2)
            end
            ...
            it 'creates runner' do
              ...
              expect(project.runners.reload.size).to eq(3)
            end
          end
        end
        ...
        context 'when group token is used' do
          ...
          context 'when abandoned runners cause application limits to not be exceeded' do
            before do
              create(:ci_runner, runner_type: :group_type, groups: [group], contacted_at: 10.seconds.ago)
              create(:ci_runner, runner_type: :group_type, groups: [group], contacted_at: 3.months.ago)
              create(:plan_limits, :default_plan, ci_registered_group_runners: 1)
            end
