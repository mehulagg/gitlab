    ...
    context 'authorized user' do
      context 'with admin privileges' do
        ...
        it 'returns all runners' do
          ...
          expect(json_response).to match_array [
            a_hash_including('description' => 'Project runner', 'is_shared' => false, 'type' => 'project_type'),
            a_hash_including('description' => 'Two projects runner', 'is_shared' => false, 'type' => 'project_type'),
            a_hash_including('description' => 'Group runner A', 'is_shared' => false, 'type' => 'group_type'),
            a_hash_including('description' => 'Group runner B', 'is_shared' => false, 'type' => 'group_type'),
            a_hash_including('description' => 'Shared runner', 'is_shared' => true, 'type' => 'instance_type')
          ]
        end
