...
RSpec.describe SearchController do
  ...
  context 'authorized user' do
    ...
    shared_examples_for 'support for active record query timeouts' do |action, params, method_to_stub|
      before do
    ...
    describe 'GET #show' do
      ...
      it_behaves_like 'support for active record query timeouts', :show, { search: 'hello' }, :search_objects
    ...
    describe 'GET #count' do
      ...
      it_behaves_like 'support for active record query timeouts', :count, { search: 'hello', scope: 'projects' }, :search_results
