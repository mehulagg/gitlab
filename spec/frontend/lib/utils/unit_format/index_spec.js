...
describe('unit_format', () => {
  it('engineering', () => {
    ...
    expect(engineering(10000)).toBe('10k');
    expect(engineering(1000000)).toBe('1M');
  ...
  it('milliseconds', () => {
    ...
    expect(milliseconds(10000)).toBe('10,000ms');
    expect(milliseconds(1000000)).toBe('1,000,000ms');
  });
