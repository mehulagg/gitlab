  ...
  describe('dropdown options', () => {
    ...
    it('adds dropdown items for all the sortable fields', () => {
      ...
      const expectedDropdownItems = [
        ...
        {
          label: 'Access expires ascending',
          url: 'https://localhost/?two_factor=enabled&search=foobar&sort=expires_at_asc',
        },
        {
          label: 'Access expires descending',
          url: 'https://localhost/?two_factor=enabled&search=foobar&sort=expires_at_desc',
        },
        {
