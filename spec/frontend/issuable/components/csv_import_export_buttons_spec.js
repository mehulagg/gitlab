...
describe('CsvImportExportButtons', () => {
  ...
  const findExportCsvModal = () => wrapper.find(CsvExportModal);
  const findImportCsvModal = () => wrapper.find(CsvImportModal);
  ...
  describe('template', () => {
    describe('when the showExportButton=true', () => {
      ...
      it('opens the export modal', () => {
        findExportCsvButton().vm.$emit('click');
    ...
    describe('when the showImportButton=true', () => {
      ...
      it('opens the import modal', () => {
        findImportCsvButton().vm.$emit('click');
