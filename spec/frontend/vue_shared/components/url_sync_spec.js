...
describe('url sync component', () => {
  ...
  describe('with scoped slot', () => {
    ...
    it('renders the scoped slot', () => {
      createComponent({ query: undefined, scopedSlots });
    ...
    it('syncs the url with the scoped slots function', () => {
      ...
      // due to the watcher this is the second call, but we can ignore the first
      expectUrlSync({ bar: 'baz' }, 2, mergeUrlParams.mock.results[1].value);
    });
  });
  ...
  describe('with slot', () => {
    ...
    it('renders the default slot', () => {
      createComponent({ query: undefined, slots });
