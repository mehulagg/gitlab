...
describe('BaseToken', () => {
  ...
  beforeEach(() => {
    wrapper = createComponent({
      recentTokenValuesStorageKey: 'recent-tokens-label_name',
  ...
  describe('data', () => {
    it('calls `getRecentlyUsedTokenValues` to populate `recentTokenValues` when `recentTokenValuesStorageKey` is defined', () => {
      expect(getRecentlyUsedTokenValues).toHaveBeenCalledWith('recent-tokens-label_name');
    });
  });
  ...
  describe('methods', () => {
    describe('handleTokenValueSelected', () => {
      it('calls `setTokenValueToRecentlyUsed` when `recentTokenValuesStorageKey` is defined', () => {
        ...
        expect(setTokenValueToRecentlyUsed).toHaveBeenCalledWith(
