...
describe('ManageViaMr component', () => {
  ...
  describe.each`
    featureName              | mutation                               | mutationId
    ${'SAST'}                | ${configureSastMutation}               | ${'configureSast'}
    ${'Dependency Scanning'} | ${configureDependencyScanningMutation} | ${'configureDependencyScanning'}
    ${'Secret Detection'}    | ${configureSecretDetectionMutation}    | ${'configureSecretDetection'}
  `('$featureType', ({ featureName, mutation, mutationId }) => {
