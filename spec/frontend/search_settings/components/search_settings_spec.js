...
describe('search_settings/components/search_settings.vue', () => {
  ...
  describe('default', () => {
    ...
    beforeEach(() => {
      generalSettings = sectionById(GENERAL_SETTINGS_ID);
      advancedSettings = sectionById(ADVANCED_SETTINGS_ID);
      extraSettings = sectionById(EXTRA_SETTINGS_ID);
    });

    // This test is assuring that our test setup is what we expect
    it('starts with expansion state', () => {
