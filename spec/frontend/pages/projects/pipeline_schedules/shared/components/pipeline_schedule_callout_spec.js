...
describe('Pipeline Schedule Callout', () => {
  ...
  const findDismissCalloutBtn = () => wrapper.find('#dismiss-callout-btn');
  ...
  describe(`when ${cookieKey} cookie is set`, () => {
    ...
    it('correctly sets calloutDismissed to true', () => {
      expect(wrapper.vm.calloutDismissed).toBe(true);
    });
  ...
  describe('when cookie is not set', () => {
    ...
    it('updates calloutDismissed when close button is clicked', async () => {
      wrapper.find('#dismiss-callout-btn').trigger('click');
    ...
    describe('methods', () => {
      it('#dismissCallout sets calloutDismissed to true', async () => {
        ...
        findDismissCalloutBtn().trigger('click');
