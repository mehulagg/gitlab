...
describe('Settings Panel', () => {
  ...
  describe('Issues settings', () => {
    it('has label for CVE request toggle', () => {
      ...
      expect(findIssuesSettingsRow().find(GlToggle).props('label')).toBe(
  ...
  describe('Container registry', () => {
    ...
    it('has label for the toggle', () => {
      ...
      expect(findContainerRegistrySettings().find(GlToggle).props('label')).toBe(
  ...
  describe('Packages', () => {
    ...
    it('has label for toggle', () => {
      ...
      expect(findPackagesEnabledInput().find(GlToggle).props('label')).toBe(
