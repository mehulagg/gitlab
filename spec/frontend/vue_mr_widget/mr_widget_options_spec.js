...
import { mockExperimentFeatureFlag } from 'helpers/experimentation_helper';
...
describe('mrWidgetOptions', () => {
  ...
  describe('suggestPipeline Experiment', () => {
    ...
    describe('given experiment is enabled', () => {
      beforeEach(() => {
        mockExperimentFeatureFlag('suggestPipeline');
    ...
    describe('given suggestPipeline experiment is not enabled', () => {
      beforeEach(() => {
        mockExperimentFeatureFlag('suggestPipeline', false);
