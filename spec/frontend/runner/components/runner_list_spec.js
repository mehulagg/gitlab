...
describe('RunnerList', () => {
  ...
  it('Displays headers', () => {
    expect(findHeaders().at(0).text()).toBe('Type/State');
    expect(findHeaders().at(1).text()).toBe('Runner');
    expect(findHeaders().at(2).text()).toBe('Version');
    expect(findHeaders().at(3).text()).toBe('IP Address');
    expect(findHeaders().at(4).text()).toBe('Projects');
    expect(findHeaders().at(5).text()).toBe('Jobs');
    expect(findHeaders().at(6).text()).toBe('Tags');
    expect(findHeaders().at(7).text()).toBe('Last contact');
    expect(findHeaders().at(8).text()).toBe('');
  });
