...
describe('ParallelDiffTableRow', () => {
  ...
  describe('Table Cells', () => {
    ...
    describe('comment button', () => {
      ...
      it.each`
        hover    | line                        | userData     | query                | expectation
        ${true}  | ${{}}                       | ${TEST_USER} | ${'diff_head=false'} | ${true}
        ${true}  | ${{ line: { left: null } }} | ${TEST_USER} | ${'diff_head=false'} | ${false}
        ${true}  | ${{}}                       | ${TEST_USER} | ${'diff_head=true'}  | ${true}
        ${true}  | ${{}}                       | ${TEST_USER} | ${'diff_head=true'}  | ${false}
        ${true}  | ${{}}                       | ${null}      | ${''}                | ${false}
        ${false} | ${{}}                       | ${TEST_USER} | ${'diff_head=false'} | ${false}
      `(
        'exists is $expectation - with userData ($userData) query ($query)',
        async ({ hover, line, userData, query, expectation }) => {
