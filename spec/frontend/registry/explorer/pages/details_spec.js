...
import {
  ...
  IMAGE_WITH_MISSING_NAME_BREADCRUMB,
...
describe('Details Page', () => {
  ...
  describe('Breadcrumb connection', () => {
    ...
    it(`when the image has no name set the breadcrumb to ${IMAGE_WITH_MISSING_NAME_BREADCRUMB}`, async () => {
      mountComponent({
        resolver: jest
          .fn()
      ...
      expect(breadCrumbState.updateName).toHaveBeenCalledWith(IMAGE_WITH_MISSING_NAME_BREADCRUMB);
    });
  });
