...
describe('Project Value Stream Analytics mutations', () => {
  ...
  it.each`
    ...
    ${types.REQUEST_STAGE_DATA}                   | ${'currentStageEvents'} | ${[]}
    ${types.RECEIVE_STAGE_DATA_SUCCESS}           | ${'isLoadingStage'}     | ${false}
    ${types.RECEIVE_STAGE_DATA_SUCCESS}           | ${'currentStageEvents'} | ${[]}
    ${types.RECEIVE_STAGE_DATA_SUCCESS}           | ${'hasError'}           | ${false}
    ${types.RECEIVE_STAGE_DATA_ERROR}             | ${'isLoadingStage'}     | ${false}
    ${types.RECEIVE_STAGE_DATA_ERROR}             | ${'currentStageEvents'} | ${[]}
  ...
  it.each`
    ...
    ${types.INITIALIZE}                           | ${{ requestPath: mockRequestPath }} | ${'requestPath'}  | ${mockRequestPath}
    ${types.SET_SELECTED_STAGE}                   | ${selectedStage}                    | ${'currentStage'} | ${selectedStage}
  ...
  describe('with a stage selected', () => {
    ...
    it.each`
      ...
      ${types.RECEIVE_STAGE_DATA_SUCCESS} | ${{ events: rawEvents }} | ${'currentStageEvents'} | ${convertedEvents}
