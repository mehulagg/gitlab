...
describe('rich_content_editor/renderers/render_image', () => {
  ...
  describe('render', () => {
    ...
    it.each`
      ...
      ${'http://gitlab.test/absolute/path/to/image.png'} | ${true}    | ${'http://gitlab.test/absolute/path/to/image.png'}
      ${'/relative/path/to/image.png'}                   | ${false}   | ${'http://gitlab.test/user1/project1/-/raw/main/default/source/relative/path/to/image.png'}
      ${'/target/image.png'}                             | ${false}   | ${'http://gitlab.test/user1/project1/-/raw/main/source/with/target/image.png'}
      ${'relative/to/current/image.png'}                 | ${false}   | ${'http://gitlab.test/user1/project1/-/raw/main/relative/to/current/image.png'}
      ${'./relative/to/current/image.png'}               | ${false}   | ${'http://gitlab.test/user1/project1/-/raw/main/./relative/to/current/image.png'}
      ${'../relative/to/current/image.png'}              | ${false}   | ${'http://gitlab.test/user1/project1/-/raw/main/../relative/to/current/image.png'}
