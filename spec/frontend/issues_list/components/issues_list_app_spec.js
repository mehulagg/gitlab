...
describe('IssuesListApp component', () => {
  ...
  const findGlButtonAt = (index) => wrapper.findAllComponents(GlButton).at(index);
  ...
  describe('when "click-tab" event is emitted by IssuableList', () => {
    ...
    it('makes API call to filter the list by the new state and resets the page to 1', async () => {
