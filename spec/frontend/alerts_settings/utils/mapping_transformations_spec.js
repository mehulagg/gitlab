...
describe('Mapping Transformation Utilities', () => {
  ...
  describe('setFieldsLabels', () => {
    ...
    const nestedFieldsResult = { displayLabel: '...Subfield', tooltip: 'field' };
    ...
    const nestedArrayFieldsResult = { displayLabel: '...Subfield', tooltip: 'fields[1]' };
    ...
    `('adds correct displayLabel and tooltip for $type', ({ fields, result }) => {
      expect(setFieldsLabels(fields)[0]).toEqual(expect.objectContaining(result));
    });
  });
});
