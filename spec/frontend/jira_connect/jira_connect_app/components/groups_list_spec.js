...
import GroupsList from '~/jira_connect/jira_connect_app/components/groups_list.vue';
import GroupsListItem from '~/jira_connect/jira_connect_app/components/groups_list_item.vue';
import { DEFAULT_GROUPS_PER_PAGE } from '~/jira_connect/jira_connect_app/constants';
...
jest.mock('~/jira_connect/jira_connect_app/api', () => {
  return {
    fetchGroups: jest.fn(),
  };
});
