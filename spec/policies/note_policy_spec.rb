...
RSpec.describe NotePolicy do
  describe '#rules', :aggregate_failures do
    ...
    describe 'the :reposition_note permission' do
      ...
      context 'when project is public' do
        context 'when the noteable is not a design' do
          it 'can read but not reposition the note' do
            expect(policy).to be_allowed(:read_note, :award_emoji)
            expect(policy).to be_disallowed(:admin_note, :resolve_note, :reposition_note)
          end
        end
        ...
        context 'when the noteable is a design' do
          ...
          it 'can read and reposition the note' do
