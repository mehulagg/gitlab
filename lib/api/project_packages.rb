  ...
  class ProjectPackages < ::API::Base
    ...
    resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      get ':id/packages' do
        ...
        present paginate(packages), with: ::API::Entities::Package, user: current_user, namespace: user_project.group
      end
      ...
      get ':id/packages/:package_id' do
        ...
        present package, with: ::API::Entities::Package, user: current_user, namespace: user_project.group
      end
