    ...
    %w[group project].each do |source_type|
      ...
      resource source_type.pluralize, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
        ...
        params do
          ...
          optional :user_id, type: Integer, desc: 'The user ID of the new member'
          optional :user_ids, type: Array[Integer], coerce_with: ::API::Validations::Types::CommaSeparatedToIntegerArray.coerce, desc: 'Array of user ids to add to group or project'
        ...
        post ":id/members" do
          ...
          if params[:user_ids].present?
            ::Members::CreateService.new(current_user, params).execute(source)
