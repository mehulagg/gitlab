  ...
  module Helpers
    module ProjectsHelpers
      ...
      params :optional_project_params_ce do
        ...
        optional :operations_access_level, type: String, values: %w(disabled private enabled public), desc: 'Operations access level. One of `disabled`, `private`, `enabled` or `public`'
