    ...
    resource :groups, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      params do
        ...
        optional :include_descendant_groups, type: Boolean, default: false,
                 desc: 'Include descendant groups. This feature was added in GitLab 13.5'
        optional :only_group_labels, type: Boolean, default: true,
                 desc: 'Toggle to include only group labels or also project labels. This feature was added in GitLab 13.5'
        optional :search, type: String,
                 desc: 'Keyword to filter labels by. This feature was added in GitLab 13.5'
        use :pagination
      end
      get ':id/labels' do
