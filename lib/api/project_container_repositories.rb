  ...
  class ProjectContainerRepositories < ::API::Base
    ...
    resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      get ':id/registry/repositories' do
        ...
        track_package_event('list_repositories', :container, user: current_user, project: user_project, namespace: current_user.namespace)
      ...
      delete ':id/registry/repositories/:repository_id', requirements: REPOSITORY_ENDPOINT_REQUIREMENTS do
        ...
        track_package_event('delete_repository', :container, user: current_user, project: user_project, namespace: current_user.namespace)
      ...
      get ':id/registry/repositories/:repository_id/tags', requirements: REPOSITORY_ENDPOINT_REQUIREMENTS do
        ...
        track_package_event('list_tags', :container, user: current_user, project: user_project, namespace: current_user.namespace)
      ...
      delete ':id/registry/repositories/:repository_id/tags', requirements: REPOSITORY_ENDPOINT_REQUIREMENTS do
        ...
        track_package_event('delete_tag_bulk', :container, user: current_user, project: user_project, namespace: current_user.namespace)
      ...
      delete ':id/registry/repositories/:repository_id/tags/:tag_name', requirements: REPOSITORY_ENDPOINT_REQUIREMENTS do
        ...
        if result[:status] == :success
          track_package_event('delete_tag', :container, user: current_user, project: user_project, namespace: current_user.namespace)
