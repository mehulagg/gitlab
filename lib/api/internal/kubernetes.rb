      ...
      namespace 'internal' do
        ...
        namespace 'kubernetes/usage_metrics' do
          ...
          params do
            ...
            optional :proxy_request_count, type: Integer, desc: 'The count to increment the proxy_request_count metric by'
          end
          post '/' do
            events = params.slice(:gitops_sync_count, :proxy_request_count)
