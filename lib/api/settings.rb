...
module API
  class Settings < ::API::Base
    ...
    params do
      ...
      optional :in_product_marketing_emails_enabled, type: Boolean, desc: 'By default in product marketing emails are enabled. Disable this option to prevent these emails from being sent.'
