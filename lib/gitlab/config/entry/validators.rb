      ...
      module Validators
        ...
        class VariablesValidator < ActiveModel::EachValidator
          ...
          def validate_each(record, attribute, value)
            ...
            elsif options[:hash_values]
              validate_key_hash_values(record, attribute, value)
            else
          ...
          def validate_key_hash_values(record, attribute, value)
            unless validate_string_or_hash_value_variables(value)
