  ...
  class UsageData
    ...
    class << self
      ...
      def system_usage_data
...

        {
          counts: {
            ...
            groups: count(Group),
            issues: add_metric(Gitlab::Usage::Metrics::Instrumentations::CountBoardsMetric::CountIssuesMetric.new(time_frame: 'all')),
      ...
      def usage_activity_by_stage_plan(time_period)
        ...
        {
          issues: add_metric(Gitlab::Usage::Metrics::Instrumentations::CountIssuesMetric.new(time_frame: time_frame)),
