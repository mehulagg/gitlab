      ...
      def usage_activity_by_stage_plan(time_period)
        {
          ...
          projects_jira_active: distinct_count(::Project.with_active_jira_integration.where(time_period), :creator_id),
          projects_jira_dvcs_cloud_active: distinct_count(::Project.with_active_jira_integration.with_jira_dvcs_cloud.where(time_period), :creator_id),
          projects_jira_dvcs_server_active: distinct_count(::Project.with_active_jira_integration.with_jira_dvcs_server.where(time_period), :creator_id)
        }
      end
      # rubocop: enable CodeReuse/ActiveRecord
