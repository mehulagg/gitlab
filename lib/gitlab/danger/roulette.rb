...
require_relative 'reviewers/weighted_reviewers'
require_relative 'reviewers/weighted_maintainers'
  ...
  module Danger
    module Roulette
      ...
      def spin_for_category(project, category, timezone_experiment: false)
        ...
        weighted_reviewers = Reviewers::WeightedReviewers.new(reviewers, traintainers).execute
        weighted_maintainers = Reviewers::WeightedMaintainers.new(maintainers).execute
