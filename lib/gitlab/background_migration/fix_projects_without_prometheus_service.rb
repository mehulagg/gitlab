  ...
  module BackgroundMigration
    ...
    class FixProjectsWithoutPrometheusService
      ...
      def create_sql(from_id, to_id)
        <<~SQL
          WITH created_records AS #{Arel::Nodes::AsWithMaterialized.add_materialized_if_supported} (
      ...
      def update_sql(from_id, to_id)
        <<~SQL
          WITH updated_records AS #{Arel::Nodes::AsWithMaterialized.add_materialized_if_supported} (
