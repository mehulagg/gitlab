  ...
  module Diff
    class HighlightCache
      ...
      def recache_due_to_size?(diff_file)
        ...
        default_max_patch_bytes = diff_file_class::DEFAULT_MAX_PATCH_BYTES
        diff_bytesize = diff_file.diff.diff.bytesize

        current_patch_safe_limit_bytes = diff_file_class.patch_safe_limit_bytes
        default_patch_safe_limit_bytes = default_max_patch_bytes / 10
