    ...
    module Handler
      class CreateMergeRequestHandler < BaseHandler
        ...
        def build_merge_request
          MergeRequests::BuildService.new(container: project, current_user: author, params: merge_request_params).execute
        end
        ...
        def create_merge_request
          ...
          if merge_request.errors.any?
            ...
            MergeRequests::CreateService.new(container: project, current_user: author).create(merge_request)
          end
        end
