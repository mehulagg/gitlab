  ...
  module Database
    module MigrationHelpers
      module V2
        ...
        #        type is used.
        # type_cast_function - A function used by the database to convert the old type to the new.
        # batch_column_name - option is for tables without primary key, in this
        #        case another unique integer column can be used. Example: :user_id
        def rename_column_concurrently(table, old_column, new_column, type: nil, type_cast_function: nil, batch_column_name: :id)
          setup_renamed_column(__callee__, table, old_column, new_column, type, type_cast_function, batch_column_name)
        ...
        #        case another unique integer column can be used. Example: :user_id
        #
        def undo_cleanup_concurrent_column_rename(table, old_column, new_column, type: nil, type_cast_function: nil, batch_column_name: :id)
          setup_renamed_column(__callee__, table, new_column, old_column, type, type_cast_function, batch_column_name)
        ...
        def setup_renamed_column(calling_operation, table, old_column, new_column, type, type_cast_function, batch_column_name)
          if transaction_open?
