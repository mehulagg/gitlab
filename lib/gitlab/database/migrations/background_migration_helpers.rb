  ...
  module Database
    module Migrations
      module BackgroundMigrationHelpers
        ...
        def queue_batched_background_migration(
          job_class_name,
          batch_table_name,
          batch_column_name,
          job_interval:,
        ...
        def abort_batched_background_migration(job_class_name)
          migration = Gitlab::Database::BackgroundMigration::BatchedMigration.find_by(job_class_name: job_class_name)

          return if migration.nil? || migration.finished?
