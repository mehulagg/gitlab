...
module Gitlab
  module GithubImport
    module Importer
      class ReviewNoteImporter
        attr_reader :note, :project, :client, :user_finder

        # note - An instance of `Gitlab::GithubImport::Representation::ReviewNote`.
        ...
        def execute
          ...
          Gitlab::Database.bulk_insert(SystemNoteMetadata.table_name, [attributes]) # rubocop:disable Gitlab/BulkInsert
