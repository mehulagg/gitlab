    ...
    class RedisVersionCheck < SystemCheck::BaseCheck
      ...
      def check?
        ...
        if !redis_version
          ...
          @custom_error_message = "Support for your Redis version #{redis_version} has been deprecated and will be removed in GitLab 13.0, see https://about.gitlab.com/releases/2020/04/22/gitlab-12-10-released/#redis-3-deprecation. Update your Redis server to a version >= #{RECOMMENDED_REDIS_VERSION}"
          status = false
        end
