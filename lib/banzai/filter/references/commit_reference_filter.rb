    ...
    module References
      ...
      class CommitReferenceFilter < AbstractReferenceFilter
        ...
        def find_object(project, id)
          ...
          _, record = @cache.records_per_parent(nodes)[project].detect { |k, _v| Gitlab::Git.shas_eql?(k, id) }
        ...
        def referenced_merge_request_commit_shas
          ...
          @referenced_merge_request_commit_shas ||= begin
            referenced_shas = @cache.references_per_parent(nodes).values.reduce(:|).to_a
