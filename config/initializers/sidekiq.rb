...
def enable_reliable_fetch?
  ...
  Feature.enabled?(:gitlab_sidekiq_reliable_fetcher, type: :ops, default_enabled: true) # rubocop:disable Scalability/OpsFeatureFlag
end

def enable_semi_reliable_fetch_mode?
  return true unless Feature::FlipperFeature.table_exists?

  Feature.enabled?(:gitlab_sidekiq_enable_semi_reliable_fetcher, type: :ops, default_enabled: true) # rubocop:disable Scalability/OpsFeatureFlag
end
