...
Gitlab.ee do
  ...
  Settings.cron_jobs['security_orchestration_policy_create_worker'] ||= Settingslogic.new({})
  Settings.cron_jobs['security_orchestration_policy_create_worker']['cron'] ||= '*/10 * * * *'
  Settings.cron_jobs['security_orchestration_policy_create_worker']['job_class'] = 'Security::CreateOrchestrationPolicyWorker'
  Settings.cron_jobs['security_orchestration_policy_rule_schedule_worker'] ||= Settingslogic.new({})
  Settings.cron_jobs['security_orchestration_policy_rule_schedule_worker']['cron'] ||= '19 * * * *'
