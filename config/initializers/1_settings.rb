...
Settings.cron_jobs['delete_expired_project_bots_worker'] ||= Settingslogic.new({})
Settings.cron_jobs['delete_expired_project_bots_worker']['cron'] ||= '0 0 * * *'
Settings.cron_jobs['delete_expired_project_bots_worker']['job_class'] = 'DeleteExpiredProjectBotsWorker'
