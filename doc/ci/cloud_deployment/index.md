...
images that come with the needed libraries and tools pre-installed. By referencing them in your
...
1. Select your newly created user to access its details. Navigate to **Security credentials > Create a new access key**.
   ...
   NOTE:
   A new **Access key ID** and **Secret access key** pair are generated. Please take a note of them right away.
