...
part of your delivery process. With Gitlab you can [deploy your application anywhere](https://about.gitlab.com/stages-devops-lifecycle/deploy-targets/). 

For some specific deployment targets GitLab is making this process less painful by providing Docker images
