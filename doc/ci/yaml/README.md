...
in GitLab 13.4. [Introduced in](https://gitlab.com/gitlab-org/gitlab/-/issues/321323) GitLab 13.12, this behaviour is also applied to [pipeline artifacts](../pipelines/pipeline_artifacts.md).
