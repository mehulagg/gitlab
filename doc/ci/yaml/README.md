...
| [`allow_failure`](#allow_failure)                  | Failed jobs don't cause pipelines to fail.                                                                                                                                          |
...
Specify `stages` to have flexible multi stage pipelines.
...
Use the `include` keyword to include external YAML files. This helps
break down the CI/CD configuration into multiple files and increases readability for long configuration files.
