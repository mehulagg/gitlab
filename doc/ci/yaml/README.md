...
Alternatively, you can have a list of rules that are all `when: never`, with a final
`when: always` rules. Pipelines that match the `when: never` rules do not run, and
**All** other pipeline types can run:
