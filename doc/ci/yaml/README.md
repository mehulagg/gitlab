...
and the keys should be the names of the environment variables that will be made available to the job.
The value of each secret will be saved in a temporary file and the path to this file will be stored
