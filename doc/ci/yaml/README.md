...
It's useful for jobs that operate exclusively on artifacts, for example, `deploy`.
...
Because Git fetching and cloning is based on a ref, such as a branch name, runners
