...
definitions. Local definitions in the `.gitlab-ci.yml` file override included definitions.
...
When the `resource_group` key is defined for a job in the `.gitlab-ci.yml` file,
