...
Currently the coverage output in [child pipelines](../parent_child_pipelines.md) will not be recorded nor displayed. Please follow [this issue](https://gitlab.com/gitlab-org/gitlab/-/issues/280818) for updates.
