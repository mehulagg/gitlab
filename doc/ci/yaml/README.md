...
> - [Became enabled by default](https://gitlab.com/gitlab-org/gitlab/-/issues/267192) on GitLab 13.6.
...
Variables support in `rules:changes`  is under development but ready for production use.
