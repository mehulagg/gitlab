...
- [Tag your runners](../runners/configure-runners.md#use-tags-to-limit-the-number-of-jobs-using-the-runner) and use the tag on jobs
  that share their cache.
- [Use runners that are only available to a particular project](../runners/runners-scope.md#prevent-a-specific-runner-from-being-enabled-for-other-projects).
