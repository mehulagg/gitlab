...
You can use [predefined CI/CD variable](../variables/predefined_variables.md) to choose
which pipeline types jobs run in, with:

- [`rules`](../yaml/README.md#onlyvariables--exceptvariables)
...
- [Scheduled pipeline](../pipelines/schedules.md).
