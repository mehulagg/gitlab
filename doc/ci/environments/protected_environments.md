...
## Protecting environments from the API 

1. Use a project, with CI that creates an environments, such as: 
...
![Group Access](/img/protected-access-group.png "Group Access")
