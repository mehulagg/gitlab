...
- After the review has passed, `topic branch` is merged into the default branch where it is deployed to staging.
- After having been approved in staging, the changes that were merged into the default branch are deployed in to production.
