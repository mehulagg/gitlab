...
[Developer role or above](../../user/permissions.md#project-members-permissions).
...
- ChatOps provides limited support for access control. If the user triggering the
  slash command has the [Developer role or above](../../user/permissions.md#project-members-permissions)
