...
You can include Docker shell commands in your CI/CD jobs.
The `gitlab-runner` user that executes the shell commands
needs permission to run Docker commands.
...
You can include Docker commands in your CI/CD jobs by:

- Registering a runner that uses the Docker executor. 
- Using the [Docker image](https://hub.docker.com/_/docker/) provided by Docker to run your job scripts.
  This configuration is referred to as "Docker-in-Docker."
