...
## Passing variables to a child pipeline

Please refer to ["Passing variables to a downstream pipeline"](multi_project_pipelines.md#passing-variables-to-a-downstream-pipeline) of [multi-project pipelines](multi_project_pipelines.md).
