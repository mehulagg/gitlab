...
NOTE: GitLab.com has a 500,000 [test case parsing limit](../user/gitlab_com/#gitlab-cicd). Self Managed administrators can manage this setting on their instance.
