...
[Starting  in GitLab 13.7](https://gitlab.com/gitlab-org/gitlab/-/issues/30101),
the variables fields are pre-filled with any [global variables with description](doc/ci/variables/README.md) defined in the
`.gitlab-ci.yml` file.
