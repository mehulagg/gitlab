...
dependencies change infrequently, like [NodeJS `/node_modules`](../caching/index.md#caching-nodejs-dependencies),
caching can speed up pipeline execution significantly.
