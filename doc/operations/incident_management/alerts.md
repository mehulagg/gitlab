...
```ruby
Feature.enable(:enable_environment_path_in_alert_details)
```
...
Feature.enable(:enable_environment_path_in_alert_details, project)
```

To disable it:

```ruby
Feature.disable(:enable_environment_path_in_alert_details)
```
