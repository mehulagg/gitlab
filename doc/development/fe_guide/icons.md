...
When adding the illustration to [GitLab SVG](https://gitlab.com/gitlab-org/gitlab-svgs) illustrations will automatically be minimized so no manual action is needed.
