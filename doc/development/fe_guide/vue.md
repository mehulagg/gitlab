...
a Rails form to Vue or integrating components (datepicker, project selector, etc) into it. The 
[`parseRailsFormFields`](https://gitlab.com/gitlab-org/gitlab/-/blob/fe88797f682c7ff0b13f2c2223a3ff45ada751c1/app/assets/javascripts/lib/utils/forms.js#L107) 
utility can be used to parse the generated form input attributes so they can be passed to the Vue application. 
Using this technique allows us to easily integrate Vue components without changing how the 
form submits.
...
> The `js_name` data attribute is used in the generated JavaScript object.
