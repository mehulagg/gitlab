...
If your application contains `@client` queries, you will have
...
mock `handlers`. For example, given the `@client` the query:
...
We will use a **mock resolver** that returns data with the
