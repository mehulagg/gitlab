...
**Editor Lite** is the technology underpinning the single-file editing experience
across GitLab features like
[Web Editor](../../user/project/repository/web_editor.md), [Snippets](../../user/snippets.md),
and [CI Linter](../../ci/lint.md). Editor Lite is a thin wrapper around
[the Monaco editor](https://microsoft.github.io/monaco-editor/), provides the necessary
helpers and abstractions, and extends Monaco using extensions.
