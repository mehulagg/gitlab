...
- Translations are entered into the central panel. Multiple translations are required for strings
  that contains plurals. The string to translate is shown in the above image with glossary terms
...
To include both genders, write _Utilisateurs et utilisatrices_ instead of _Utilisateur·rice·s_. When
space is missing, use the male gender alone.
<!-- vale gitlab.Spelling = YES -->
