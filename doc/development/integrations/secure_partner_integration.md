...
1. Optional: Provide auto-remediation steps:
   - If you specified `remediations` in your artifact, it is proposed through our [automatic remediation](../../user/application_security/vulnerabilities/manage_vulnerabilities.md#apply-an-automatic-remediation-for-a-vulnerability)
     interface.
