...
| {::nomarkdown}<div style="width:140px">Usage</div>{:/} | Guidance | [Vale](../testing.md#vale) Tests |
|-|-|-|
...
| easily | Do not use. If the user doesn't find the process to be these things, we lose their trust. | None |
| e.g. | Do not use Latin abbreviations. Use **for example**, **such as**, **for instance**, or **like** instead. | [`LatinTerms.yml`](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/.vale/gitlab/LatinTerms.yml) |
...
| handy | Do not use. If the user doesn't find the process to be these things, we lose their trust. | None |
...
| i.e. | Do not use Latin abbreviations. Use **that is** instead. | [`LatinTerms.yml`](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/.vale/gitlab/LatinTerms.yml) |
...
| simply | Do not use. If the user doesn't find the process to be these things, we lose their trust. | None |
...
| useful | Do not use. If the user doesn't find the process to be these things, we lose their trust. | None |
| via | Do not use Latin abbreviations. Use **with**, **through**, or **by using** instead. | [`LatinTerms.yml`](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/.vale/gitlab/LatinTerms.yml) |
