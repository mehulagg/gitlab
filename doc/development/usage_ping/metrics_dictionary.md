...
| `skip_validation`   | no       | This should **not** be set for new metrics. [Used for imported metrics until we review, update and make them valid](https://gitlab.com/groups/gitlab-org/-/epics/5425). |
