...
- `implemented`: Metric is implemented but data is not yet available. This is a temporary status for newly added metrics that are waiting to be included in a new release.
