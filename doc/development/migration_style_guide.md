...
do not take too much time: In general, queries executed in a migration should aim to be less
than `1s` on GitLab.com. GitLab.com’s production database has a `15s` timeout.
