...
See the [Documentation Style Guide RESTful API page](documentation/restful-api-styleguide.md) for details on documenting API resources in Markdown as well as in OpenAPI definition files.
