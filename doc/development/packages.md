...
Files uploaded to the GitLab Package Registry are [limited by format](../administration/instance_limits.html#file-size-limits.md). On GitLab.com, these are typically set to 5GB to help prevent timeout issues and abuse. 
