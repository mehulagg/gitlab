...
This document guides you through adding support for a new a [package management system](../administration/packages/index.md) to GitLab.
...
Files uploaded to the GitLab Package Registry are [limited by format](../administration/instance_limits.md#package-registry-limits). On GitLab.com, these are typically set to 5GB to help prevent timeout issues and abuse. 
