...
> Introduced in 13.7 (https://gitlab.com/gitlab-org/gitlab/-/merge_requests/48512/diffs)

The import progress can be checked in the `logs/importer.log` file. Each
relevant import information is logged with `"import_source": "github"`
and the `"project_id"`.

> Introduced in 14.1 (https://gitlab.com/gitlab-org/gitlab/-/merge_requests/64256)
