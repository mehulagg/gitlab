...
- Write the raw SQL in the MR description. Preferably formatted
  ...
  should include both the version of the simple query over issues and the one that joins issues and projects and applies the filter.
- Provide the link to the plan at: [explain.depesz.com](https://explain.depesz.com). Paste both the plan and the query used in the form.
  ...
  Finally, if a query is going to be always used with a limit and an offset, those should always be included with the maximum allowed limit used and a non 0 offset.
