...
in a *post-deployment migration*, as shown in this example:
...
schedule these jobs have stopped running. See also [other examples](https://docs.gitlab.com/ee/development/post_deployment_migrations.html#use-cases)
