...
- Once you've pushed up your changes, consider waiting for the pipelines to finish
  running successfully before assigning your MR to a reviewer. This allows the
  reviewer to confidently review/approve the changes in a single asynchronous
  session, rather than having to revisit the MR multiple times while they wait for
  the pipelines to finish.
