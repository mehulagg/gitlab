...
- Consider using the [Squash and
  ...
  author has already set this option: if the merge request clearly contains a
  messy commit history, it will be more efficient to squash commits instead of
  circle back with the author about that. Otherwise, if the MR only has a few commits, we'll
