...
When self-identifying as a domain expert, it is recommended that the MR changing the `team.yml` is reviewed and merged by an already established Domain Expert or a corresponding Engineering Manager.
