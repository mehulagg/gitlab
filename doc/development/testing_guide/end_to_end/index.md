...
This is due to technical limitations in GitLab's permission model: the ability to run a pipeline
...
For security reasons and implications, we couldn't open up the default branch branch to all the Developers.
