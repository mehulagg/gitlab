...
### When should I use Karma over Jest?

Only ever use Karma when your tests require a browser and there is no obvious way of achieving the
same test behavior with Jest.
