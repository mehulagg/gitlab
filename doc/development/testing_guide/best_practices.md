...
To share primitive values across examples, we can use parameter types [`ref` and `lazy`](https://github.com/tomykaira/rspec-parameterized/pull/62/commits/af731f8bc75ea0dffed14696dfc655859237663d).
