...
- Any change that adds new Usage Data metrics, sets existing ones as removed, and changes that need to be documented in Product Intelligence [Metrics Dictionary](usage_ping/dictionary.md) **should** have a changelog entry.
