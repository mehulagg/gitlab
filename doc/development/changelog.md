...
- Any change that adds new usage data metrics and changes than need to be documented in Product Analytics [Event Dictionary](telemetry/event_dictionary.md) **should** have a changelog entry.
