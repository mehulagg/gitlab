...
You can then connect to this session by using the `pry-shell` executable. You can watch
[this video](https://www.youtube.com/watch?v=Lzs_PL_BySo), for more information about
