...
This endpoint attempts to fully utilize a single core, at 100%, for the given period.
...
This endpoint attempts to fully utilize a single core, and interleave it with DB request, for the given period.
