...
and work on reducing these numbers. Reduced timing will be consequence of reduced
...
but difference in cache state and I/O speed may lead to different timing.
