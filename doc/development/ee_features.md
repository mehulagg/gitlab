...
Frotend features should be guarded by pushing a flag from the backend by using `push_licensed_feature`, and checked using `this.glFeatures.someFeature` in the frontend.
