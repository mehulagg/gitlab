...
- `setting`: for  setting related metrics.
- `count_7d`:  for counters that have data for the recent 7 days.
- `count_28d`:  for counters that have data for the recent 28 days.
- `count_all`:  for counters that have data for all time.
