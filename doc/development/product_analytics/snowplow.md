...
1. Install snowplow micro by cloning the settings in [this project](https://gitlab.com/gitlab-org/snowplow-micro):

   ```shell
   git clone git@gitlab.com:gitlab-org/snowplow-micro.git
   ./snowplow-micro.sh
   ```
