...
1. [**GitLab Helm chart**](https://docs.gitlab.com/ee/install/README.html#installing-gitlab-on-kubernetes-via-the-gitlab-helm-charts): The cloud native Helm chart for installing GitLab and all its components on Kubernetes.
1. [**Docker**](https://docs.gitlab.com/ee/install/README.html#installing-gitlab-with-docker): The Omnibus GitLab packages dockerized.
1. [**Source**](https://docs.gitlab.com/ee/install/README.html#installing-gitlab-from-source): Install GitLab and all its components from scratch.
