...
- **EC2**: GitLab is deployed on shared hardware, which means
  [on-demand pricing](https://aws.amazon.com/ec2/pricing/on-demand/) applies.
  If you want to run it on a dedicated or reserved instance, see the
  [EC2 pricing page](https://aws.amazon.com/ec2/pricing/) for information about
  its cost.
- **S3**: We use S3 ([pricing page](https://aws.amazon.com/s3/pricing/)) to
