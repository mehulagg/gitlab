...
1. On the top bar, select **Menu >** **{admin}** **Admin > Settings > Advanced Search**.
...
1. After the indexing has completed, enable **Search with Elasticsearch enabled** and click **Save changes**.
...
1. On the top bar, select **Menu >** **{admin}** **Admin > Settings > Advanced Search > Elasticsearch zero-downtime reindexing**.
...
The following reindex settings are available in **Menu >** **{admin}** **Admin > Settings > Advanced Search > Elasticsearch zero-downtime reindexing**:
...
1. Uncheck the **Pause Elasticsearch indexing** checkbox in **Menu >** **{admin}** **Admin > Settings > Advanced Search**.
