...
### Access requirements for the self-hosted AWS Elasticsearch Service

To use the self-hosted AWS Elasticsearch Service with GitLab, configure your instance's domain access policies
