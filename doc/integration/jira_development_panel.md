...
| Your own server | The [Jira DVCS (distributed version control system) connector](../../../integration/jira_development_panel.md). This syncs data hourly. | The [Jira DVCS connector](../../../integration/jira_development_panel.md). |
