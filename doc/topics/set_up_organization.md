...
- API introduction and rate limits:
  - [GitLab self-managed](#api-and-rate-limits-for-self-managed-gitlab)
  - [GitLab SaaS](#api-and-rate-limits-for-gitlab-saas)
- [Where to find additional training](#gitlab-training-resources)
...
### Your self-managed rate limit checklist
...
- [**HAProxy API throttle**](../user/gitlab_com/index.md#haproxy-api-throttle): GitLab SaaS responds with HTTP status code 429 to API requests that exceed 10 requests per second, per IP address.
...
### Your GitLab SaaS rate limit checklist
...
We want you to be successful, so we offer several ways to find the right training to get the most out of your GitLab application.

### GitLab training - paid
...
### GitLab training - free

- GitLab basics: Discover our self-service guides on [Git and GitLab basics](../gitlab-basics/index.md).
- Discover GitLab Learn: Learn new GitLab skills in a structured course at [GitLab Learn](https://about.gitlab.com/learn/).
...
- LinkedIn Learning: Check out [Continuous Delivery with GitLab](https://www.linkedin.com/learning/continuous-delivery-with-gitlab) on LinkedIn Learning for another low-cost, guided training option.

### Your training checklist

- Add the resources listed here to your internal GitLab training documentation.
