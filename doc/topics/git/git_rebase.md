...
In GitLab, if there are no [merge conflicts](#merge-conflicts), you can rebase
your feature branch directly from the merge request through a
...
executes it in the next couple of minutes.
