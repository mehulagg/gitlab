...
To deploy a project to Google Kubernetes Engine:

- [Step 1: Configure your Google account](#configure-your-google-account)
- [Step 2: Create a new project from a template](#create-a-new-project-from-a-template)
- [Step 3: Create a Kubernetes cluster in GitLab](#create-a-kubernetes-cluster-in-gitlab)
- [Step 4: Install Ingress](#install-ingress)
- [Step 5: Configure your base domain](#configure-your-base-domain)
- [Step 6: Enable Auto DevOps](#enable-auto-devops-optional)
- [Step 7: Deploy the application](#deploy-the-application)
...
## Create a Kubernetes cluster in GitLab

1. On your project's landing page, select **Add Kubernetes cluster**.
   This option is also available when you go to
...
You created a Google GKE cluster, so you can install NGINX Ingress Controller
