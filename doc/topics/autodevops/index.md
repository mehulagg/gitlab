...
- either under the cluster's settings, whether for an instance,
  [projects](../../user/project/clusters/add_remove_clusters.md#base-domain) or
...
[existing between them](../../user/project/clusters/add_remove_clusters.md#multiple-kubernetes-clusters).
