...
> - Became default in [GitLab 14.0](TODO).
...
> Replaced with Cloud Native Buildpacks in [GitLab 14.0](TODO)
...
still be used by setting the CI variable `AUTO_DEVOPS_BUILD_IMAGE_CNB_ENABLED`
to `false`.
