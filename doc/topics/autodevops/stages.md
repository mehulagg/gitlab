...
In addition to enable a cilium network policy as part of your deployment, alerts can also be enabled. The network policies
with alerts enabled will be considered only if [GitLab Kubernetes Agent](https://docs.gitlab.com/13.6/ee/user/clusters/agent/) has been
integrated.

You can enable alerts as the following:
