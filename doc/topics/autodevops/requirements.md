...
- **GitLab Runner** (for all stages)
  ...
  Runners should be registered as [shared runners](../../ci/runners/runners-scope.md#shared-runners)
  for the entire GitLab instance, or [specific runners](../../ci/runners/runners-scope.md#specific-runners)
