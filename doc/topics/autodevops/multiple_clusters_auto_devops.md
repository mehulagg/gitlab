...
used defines 3 environment names:
...
After completing configuration, you can test your setup by creating a merge request. Verify whether your application was deployed as a Review App in the Kubernetes
