...
- A [group deploy token](../../../user/project/deploy_tokens/index.md#group-deploy-token).
...
You can also use [custom CI/CD variables](../../../ci/variables/README.md#custom-cicd-variables) to store and access your personal access token or deploy token.
