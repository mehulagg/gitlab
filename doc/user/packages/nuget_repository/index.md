...
- The maximum allowed size on GitLab.com is 500 Megabytes. The size is [configurable for self-managed GitLab instances](../../../administration/instance_limits.md#package-registry-limits). 
