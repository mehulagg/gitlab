...
# GitLab Terraform Module Registry **(FREE)**
...
To authenticate to the Terraform Module Registry, you need either a [personal access token](../../../api/README.md#personalproject-access-tokens),
...
curl --header "PRIVATE-TOKEN: <your_access_token>" \
     ...
     "https://gitlab.example.com/api/v4/projects/24/packages/terraform/modules/my-module/my-system/0.0.1/file"
```
...
Where `gitlab.com` can be replaced with the hostname of your GitLab instance for self-managed.
