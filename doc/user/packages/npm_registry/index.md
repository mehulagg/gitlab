...
Only [scoped](https://docs.npmjs.com/cli/v6/using-npm/scope) packages are supported.
...
You can add [distribution tags](https://docs.npmjs.com/cli/v6/commands/npm-dist-tag) to newly-published packages.
