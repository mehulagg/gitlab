...
## Optional enforcement of Personal Access Token expiration **(ULTIMATE SELF)**
...
> - To use it in GitLab self-managed instances, ask a GitLab administrator to [enable it](#enable-or-disable-optional-enforcement-of-personal-access-token-expiration-feature). **(FREE SELF)**

GitLab administrators can choose to prevent personal access tokens from expiring
automatically. The tokens are usable after the expiration date, unless they are revoked explicitly.
...
### Enable or disable optional enforcement of Personal Access Token expiration Feature **(FREE SELF)**

Optional Enforcement of Personal Access Token Expiration is deployed behind a feature flag and is **disabled by default**.
