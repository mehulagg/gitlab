...
| `DS_PYTHON_VERSION`                     | `retire.js`        |                              | Version of Python. If set to 2, dependencies are installed using Python 2.7 instead of Python 3.6. ([Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/12296) in GitLab 12.1, [removed](https://gitlab.com/gitlab-org/gitlab/-/issues/250330) in GitLab 13.7)|
...
Python 2 was removed (see: [sunset python 2](https://www.python.org/doc/sunset-python-2/)) from the `retire.js` analyzer in GitLab `13.7` (analyzer version `v2.10.1`). Projects using packages
with a dependency on this version of python should use `retire.js` version `v2.10.0` or lower (e.g. `registry.gitlab.com/gitlab-org/security-products/analyzers/retire.js:2.10.0`).
