...
| `DS_EXCLUDED_ANALYZERS`      | Specify the analyzers to be excluded from Dependency Scanning by name. Read more about [customizing analyzers](analyzers.md). |
| `DS_DEFAULT_ANALYZERS`      | (**DEPRECATED - use `DS_EXCLUDED_ANALYZERS` instead**) Override the names of the official default images. Read more about [customizing analyzers](analyzers.md). |
