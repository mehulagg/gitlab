...
| `DS_DEFAULT_ANALYZERS`      | (**DEPRECATED - use `DS_EXCLUDED_ANALYZERS` instead**) Override the names of the official default images. For more information, see [Dependency Scanning Analyzers](analyzers.md). |
