...
> [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/285476) in [GitLab Ultimate] 13.10, options to zoom in on a date range, and download the vulnerabilities chart.
