...
| `DAST_AUTH_EXCLUDE_URLS` | URLs | The URLs to skip during the authenticated scan; comma-separated. Regular expression syntax can be used to match multiple URLs. For example, `.*` matches an arbitrary character sequence. Not supported for API scans. > - [Deprecated](https://gitlab.com/gitlab-org/gitlab/-/issues/289959) in GitLab 14.0. Replaced by `DAST_EXCLUDE_URLS`. |
