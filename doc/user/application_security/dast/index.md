...
variables:
  ...
  DAST_SUBMIT_FIELD: login # the element id or name of the submit element or button used to sign in
  DAST_FIRST_SUBMIT_FIELD: login #the element id or name of the submit element or button used to sign in. Useful for a two screen sign in flow
...
| `DAST_SUBMIT_FIELD` | string | The element `id` or `name` of the submit element or button used to sign in. |
| `DAST_FIRST_SUBMIT_FIELD` | string | The element `id` or `name` of the submit element or button used to sign in. Useful when the sign in flow requires a button click to navigate from  `DAST_USERNAME_FIELD` to `DAST_PASSWORD_FIELD`. |
