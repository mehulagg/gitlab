...
If your application is experiencing any latency or is returning many navigation failures it may be worth adjusting the values such as the below configuration:
...
NOTE:
Adjusting these values may impact scan time as they are adjusting how long each browser waits for various activities to complete.
