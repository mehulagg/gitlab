...
**Date and time** column, **Events** column, and the **Status** column. You can filter the list with the **Policy Name** filter and the **Status** filter at the top. Use the selector menu in the **Status** column
