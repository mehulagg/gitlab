...
GitLab projects page at **Settings > CI/CD**, in the **Variables** section. Then use that variable
...
3. To validate that authentication is working, run an API fuzzing test and review the fuzzing logs
