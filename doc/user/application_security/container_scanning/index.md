...
GitLab 14.0 for regular updates and the latest features. Instructions on how to have a smooth transition from Clair/Klar to Trivy can be found in the following sections.
