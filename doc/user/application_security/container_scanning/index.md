...
| `CS_SEVERITY_THRESHOLD`        | `UNKNOWN`     | Severity level threshold. Vulnerabilities with severity level higher than or equal to this threshold are output. Supported levels are Unknown, Low, Medium, High, Critical | Trivy |
