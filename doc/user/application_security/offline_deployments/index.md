...
The [automatic remediation for vulnerabilities](../vulnerabilities/manage_vulnerabilities.md#apply-an-automatic-remediation-for-a-vulnerability) feature is available for offline Dependency Scanning and Container Scanning, but may not work
