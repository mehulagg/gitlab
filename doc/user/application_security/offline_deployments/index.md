...
The [remediating vulnerabilities](../vulnerabilities/index.md#remediate-a-vulnerability) feature is available for offline Dependency Scanning and Container Scanning, but may not work
