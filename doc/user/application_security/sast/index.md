...
an analyzer to a specific release. This can be done by overriding `SAST_ANALYZER_IMAGE_TAG`
within the job template directly.

In the example below, we are pinning to a specific patch version of our `spotbugs` analyzer:
