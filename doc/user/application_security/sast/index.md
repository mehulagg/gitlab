...
pipelines tab on merge requests by [setting `artifacts: paths`](../../../ci/pipelines/job_artifacts.html#defining-artifacts-in-gitlab-ciyml) to `gl-sast-report.json`. For more information see [Downloading artifacts](../../../ci/pipelines/job_artifacts.md).
