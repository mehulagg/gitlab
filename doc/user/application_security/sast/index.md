...
| `COMPILE`                   | Gosec, SpotBugs   | Set to `false` to disable project compilation and dependency fetching. [Introduced for <!-- vale gitlab.Spelling = NO -->spotbugs<!-- vale gitlab.Spelling = YES -->](https://gitlab.com/gitlab-org/gitlab/-/issues/195252) in GitLab 13.1 and [gosec](https://gitlab.com/gitlab-org/gitlab/-/issues/330678) in GitLab 14.0.  |
