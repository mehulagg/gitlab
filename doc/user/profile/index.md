...
- Set it on your profile:
  ...
  | Notes | Note headers |
  | --- | --- | 
  | ![Busy status - notes](img/busy_indicator_notes_v13_9.png) | ![Busy status - note header](img/busy_indicator_note_header_v13_9.png) | ![Busy status - user popovers](img/busy_indicator_user_popovers_v13_9.png) |
