...
1. The second line separates the headers from the cells, and must contain only one or more hyphens (`-`)
   - The amount of hyphens has no impact on how the table renders - 1 is as good as 20
   - Any content other than hyphens and whitespace is not allowed
