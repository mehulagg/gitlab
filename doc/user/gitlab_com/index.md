...
| Setting                       | GitLab.com  | Default       |
| -----------                   | ----------- | ------------- |
| [Repository size including LFS, Package Registry, and the Container Registry](../admin_area/settings/account_and_limit_settings.md#repository-size-limit) | 10 GB       | Unlimited     |
