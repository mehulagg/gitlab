...
> - [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/228675) in GitLab 13.7.
> - It's [deployed behind a feature flag](../feature_flags.md), enabled by default.
> - It's enabled on GitLab.com.
> - It's recommended for production use.
> - For GitLab self-managed instances, GitLab administrators can opt to [disable it](#enable-or-disable-group-filtering-and-sorting). **(CORE ONLY)**

### Membership filter

By default, members inherited from parent groups and direct members are displayed. The Membership filter can be used to display only inherited or only direct members.
...
Members can be searched for by name, username, or email.

![Group members search](img/group_members_search_13_7.png)

### Sorting

Members can be sorted by "Account", "Access granted", "Max role", or "Last sign-in" in ascending or descending direction.

![Group members sort](img/group_members_sort_13_7.png)

### Enable or disable group filtering and sorting **(CORE ONLY)**

Group filtering and sorting is under development but ready for production use.
