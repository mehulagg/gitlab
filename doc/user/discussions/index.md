...
> - For GitLab self-managed instances, GitLab administrators can opt to [disabled it](#disable-or-enable-custom-commit-messages-for-suggestions). **(FREE SELF)**
...
### Disable or enable Custom commit messages for suggestions **(FREE SELF)**
