...
### Filtering merge requests by deployments data **(CORE)**
...
you can choose from. When filtering by a deploy date, you must enter the date
manually. Deploy dates use the format `YYYY-MM-DD HH:MM`, and must be quoted if
you wish to specify both a date and time.

![Filter MRs by their environment](img/filtering_merge_requests_by_environment.png)
![Filter MRs by a deploy date](img/filtering_merge_requests_by_date.png)
