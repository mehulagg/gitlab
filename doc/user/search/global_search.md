...
The Global Search in GitLab is a powerful search service that saves
you time. It leverages Elasticsearch for faster, more advanced code
search across your entire GitLab instance when searching in:
...
The Global Search can be useful in various scenarios:

- **Faster searches:**
  Global Search is based on Elasticsearch, which is a purpose built full
...
The Global Search syntax supports fuzzy or exact search queries with prefixes,
...
![Global Search](img/global_search_v13.9.png)
...
Global Search also supports the use of filters. The available filters are:
