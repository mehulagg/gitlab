...
NOTE: **Note:** 
if you want to configure any additional options related to KAS
please refer to the **Enable GitLab KAS** section of [GitLab.rb template](https://gitlab.com/gitlab-org/omnibus-gitlab/-/blob/master/files/gitlab-config-template/gitlab.rb.template).
The options will be described in the documentation in scope of the issue [Describe KAS options available for Omnibus GitLab](https://gitlab.com/gitlab-org/gitlab/-/issues/276899.
