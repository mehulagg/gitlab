...
credentials and certificates. This feature requires giving the highest level of access and control to GitLab, which could mean, if GitLab is compromised the security of this Vault instance will be as well. To avoid this security risk, GitLab recommends using your own HashiCorp Vault to leverage [external secrets with CI](https://docs.gitlab.com/ee/ci/secrets/index.html).
