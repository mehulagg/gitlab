...
better [GitOps driven alternatives](https://about.gitlab.com/direction/configure/kubernetes_management/#gitlab-managed-applications) to our users via the newly introduced [Kubernetes agent](agent/index.md) in future GitLab releases.
