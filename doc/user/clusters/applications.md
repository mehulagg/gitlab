...
Trying to create additional block storage volumes may lead to the following error when using DigitalOcean:
...
This is due to DigitalOcean imposing a few limits with regards to creating additional block storage volumes that are [documented here](https://www.digitalocean.com/docs/volumes/#limits).
