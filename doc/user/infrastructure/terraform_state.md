...
Amazon S3 or Google Cloud Storage. Once [set up by the GitLab administrator](https://docs.gitlab.com/ee/administration/terraform_state.html), its features include:
