...
- Leverage [Elasticsearch](../integration/elasticsearch.md) with [Global Search](search/global_search.md) for faster, more advanced code search across your entire GitLab instance.
