...
installing and configuring Fluentd. Fluentd can be installed through GitLab:

- The [Cluster Management Project](../../../../clusters/applications.md#install-fluentd-using-gitlab-cicd)
