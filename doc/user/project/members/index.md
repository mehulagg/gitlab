...
that you'd like to give the user. Note that you can add more than one user at a time.
The Owner role is assigned at project creation and can't be given to others.
