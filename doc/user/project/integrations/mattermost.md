...
1. Save it, copy the **Webhook URL**, we need this later for GitLab.
...
| Field | Description |
| ----- | ----------- |
| **Webhook**  | The incoming webhook URL which you have to set up on Mattermost, it is something like: `http://mattermost.example/hooks/5xo…` |
