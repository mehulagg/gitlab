...
#### Reviewer approval rules **(STARTER)**
...
> - It's recommended for production use.
> - It can be enabled or disabled for a single project.
> - For GitLab self-managed instances, GitLab administrators can opt to [disable it](#enable-or-disable-reviewer-approval-rules). **(STARTER ONLY)**
...
##### Enable or disable Reviewer Approval Rules **(STARTER ONLY)**
