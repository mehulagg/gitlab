...
When creating or editing a merge request, expand **Approval Rules** to see what rules the merge
request is subject to. To change them, follow the same steps for [adding or editing a default approval rule](#adding--editing-a-default-approval-rule).
