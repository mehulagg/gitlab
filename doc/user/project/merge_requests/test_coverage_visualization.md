...
By default the [combined artifact](https://docs.gitlab.com/ee/ci/pipelines/pipeline_artifacts.html#storage) used to decorate the Merge Request will expire **one week** after creation.
