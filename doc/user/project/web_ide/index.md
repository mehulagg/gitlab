...
The image keyword will create a container with the specified image; Specifying an image has no effect, for example, when using the [shell executor](https://docs.gitlab.com/runner/executors/shell.html).
