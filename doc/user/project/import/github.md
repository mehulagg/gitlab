...
To use a newer personal access token in imports after having previously performed these steps, sign-out of your GitLab account and sign-in again or revoke the older personal access token in GitHub.
