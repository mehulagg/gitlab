...
| `/estimate <time>`                    | **{check-circle}** Yes | **{check-circle}** Yes | **{dotted-circle}** No | Set time estimate. For example, `/estimate 1w 2d 3h 4m`. Learn more about [time tracking](time_tracking.md). |
...
| `/spend <time> [<date>]` | **{check-circle}** Yes | **{check-circle}** Yes | **{dotted-circle}** No | Add or subtract spent time. Optionally, specify the date that time was spent on. For example, `/spend -1w 2d 3h 4m 2018-08-26`. Learn more about [time tracking](time_tracking.md). |
