...
| `/reassign @user1 @user2`             | ✓     | ✓             |      | Replace current assignees with these. **(STARTER)**                                                                                                   |
| `/relabel ~label1 ~label2`            | ✓     | ✓             | ✓    | Replace current labels with these.                                                                                  |
...
| `/unlabel ~label1 ~label2` or `/remove_label ~label1 ~label2` | ✓     | ✓             | ✓    | Remove specific labels.                                                                          |
