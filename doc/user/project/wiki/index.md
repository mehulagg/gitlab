...
- *In GitLab versions 14.1 and later,* wikis inherit the
  [default branch name](../repository/branches/default.md) you configured for
  your instance or group. If no custom value is configured, GitLab uses `main`.
- *In GitLab versions 14.0 and earlier,* GitLab uses `master`.
