...
To help avoid abuse, be default, users are rate limited to:
...
Please note that GitLab.com may have [different settings](../../gitlab_com/index.md#import-export) from the defaults.
