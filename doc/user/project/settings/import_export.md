...
- Imported users can be mapped by their primary email on self-managed instances, if an administrative user (not an owner) does the import.
  ...
  - For project migration imports performed over GitLab.com Groups, preserving author information is possible through a [professional services engagement](https://about.gitlab.com/services/migration/).
