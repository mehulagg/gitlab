...
| `container_registry_cleanup_tags_service_max_list_size`  | integer          | no                   | (Currently behind a feature flag. Check here for [more details](./user/packages/container_registry/#set-cleanup-limits-to-conserve-resources)) Specify a max number of tags for Container Registry cleanup policies. |
| `container_registry_delete_tags_service_timeout`  | integer | no                                   | (Currently behind a feature flag. Check here for [more details](./user/packages/container_registry/#set-cleanup-limits-to-conserve-resources))Specify amount of time before the Container Registry delete tags service timeouts. |
| `container_registry_expiration_policies_worker_capacity`  | integer     | no                       | (Currently behind a feature flag. Check here for [more details](./user/packages/container_registry/#set-cleanup-limits-to-conserve-resources))Specify the amount of workers allocated to Container Registry cleanup policies. |
