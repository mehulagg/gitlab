...
| `keep_latest_artifact`                   | boolean          | no                                   | Locks artifacts for the most recent successful job/pipeline to prevent deletion regardless of the expiry time. Enabled by default.
