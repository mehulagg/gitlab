...
| `elasticsearch_username`                 | string           | no                                   | **(PREMIUM)** The username to use for connecting to Elasticsearch. |
| `elasticsearch_password`                 | string           | no                                   | **(PREMIUM)** The password to use for connecting to Elasticsearch. |
