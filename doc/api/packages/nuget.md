...
Download a NuGet package file. This URL is provided by the [metadata services](#metadata-service).
...
Search for NuGet packages within the repository given a query
