...
| `mergeTrainsManualMergeDisabled` | Boolean! | Whether merges via quick action and the merge immediately button are disabled for projects where merge trains are enabled. |
