...
### CreateIterationsCadencePayload

Autogenerated return type of CreateIterationsCadence.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
| `iterationsCadence` | IterationsCadence | The created iterations cadence. |
...
| `iterationsCadences` | IterationsCadenceConnection | Find iterations cadences. |
...
Represents an iterations cadence.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `active` | Boolean | Active flag to activate or deactivate an iterations cadence. |
| `automatic` | Boolean | Automatic flag to set the iterations cadence to automatically generate future iterations. |
| `durationInWeeks` | Int! | Duration in weeks of an iterations under this cadence. |
| `id` | IterationsCadenceID! | Global ID of the iterations cadence. |
| `iterationsInAdvance` | Int! | Iterations in advance to be created when iterations cadence is set to automatic. |
| `startDate` | Time | Timestamp of the iterations cadence start date. |
| `title` | String! | Title of the iterations cadence. |
