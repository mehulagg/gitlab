...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `jobs` | CiConfigJobs! => Array | Jobs in group |
...
Autogenerated return type of ConfigLint.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
| `stages` | CiConfigStage! => Array | Result for the YAML processor |
| `status` | String | Status of linting, can be either valid or invalid |
