...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `captchaSiteKey` **{warning-solid}** | [`String`](#string) | **Deprecated:** Use SPAM protection with HTTP Headers instead. Deprecated in 13.11. |
| `clientMutationId` | [`String`](#string) | A unique identifier for the client performing the mutation. |
| `errors` | [`[String!]!`](#string) | Errors encountered during execution of the mutation. |
| `needsCaptchaResponse` **{warning-solid}** | [`Boolean`](#boolean) | **Deprecated:** Use SPAM protection with HTTP Headers instead. Deprecated in 13.11. |
| `snippet` | [`Snippet`](#snippet) | The snippet after mutation. |
| `spam` **{warning-solid}** | [`Boolean`](#boolean) | **Deprecated:** Use SPAM protection with HTTP Headers instead. Deprecated in 13.11. |
| `spamLogId` **{warning-solid}** | [`Int`](#int) | **Deprecated:** Use SPAM protection with HTTP Headers instead. Deprecated in 13.11. |
