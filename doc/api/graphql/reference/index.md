...
Represents the count of vulnerabilities by severity on a particular day. This data is retained for one year.
...
Represents the number of vulnerabilities for a particular severity on a particular day. This data is retained for one year.
