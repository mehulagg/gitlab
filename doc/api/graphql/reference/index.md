...
| `metricImageUploads` | MetricImageUpload! => Array | Metric images associated to the issue. |
...
### IssueUploadMetricPayload

Autogenerated return type of IssueUploadMetric.
