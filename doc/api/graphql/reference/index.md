...
| <a id="cirunnerjobcount"></a>`jobCount` | [`Int!`](#int) | Number of jobs processed by the runner. |
...
| <a id="cirunnerprojectcount"></a>`projectCount` | [`Int!`](#int) | Number of projects attached to the runner. |
