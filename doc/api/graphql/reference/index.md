...
| <a id="packagesortproject_path_asc"></a>`PROJECT_PATH_ASC` | Ordered by project path in ascending order. |
| <a id="packagesortproject_path_desc"></a>`PROJECT_PATH_DESC` | Ordered by project path in descending order. |
