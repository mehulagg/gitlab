...
| Value | Description |
| ----- | ----------- |
| `all` | Merge Request is in any state |
| `closed` | Merge Request is closed, not merged |
| `locked` | Merge Request that has its discussion locked |
| `merged` | Merge Request has been merged |
| `opened` | Merge Request is open |
