...
| `labelEvents` | [`LabelEventConnection`](#labeleventconnection) | Label events, indicating when labels were added and removed. |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `action` | [`LabelEventAction!`](#labeleventaction) | What happened to the label. |
| `createdAt` | [`Time!`](#time) | When the action happened. |
| `issuable` | [`Issuable!`](#issuable) | The resource the label was added to or removed from. |
| `label` | [`Label!`](#label) | The label this event describes. |
| `user` | [`User`](#user) | The user that caused this event. |

### `LabelEventConnection`

The connection type for LabelEvent.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `edges` | [`[LabelEventEdge]`](#labeleventedge) | A list of edges. |
| `nodes` | [`[LabelEvent]`](#labelevent) | A list of nodes. |
| `pageInfo` | [`PageInfo!`](#pageinfo) | Information to aid in pagination. |
...
| ----- | ---- | ----------- |
| `cursor` | [`String!`](#string) | A cursor for use in pagination. |
| `node` | [`LabelEvent`](#labelevent) | The item at the end of the edge. |
...
Action of a label event.

| Value | Description |
| ----- | ----------- |
| `ADD` | An event to add the label. |
| `REMOVE` | An event to remove the label. |
...
| ----- | ---- | ----------- |
| `description` | [`String`](#string) | Description of the issue. |
| `id` | [`ID`](#id) | ID of the issuable. |
| `reference` | [`String!`](#string) | Internal reference of the issuable. Returned in shortened format by default. |
| `title` | [`String`](#string) | Title of the issue. |
