...
### AlertPayloadExtractFieldsPayload

Autogenerated return type of AlertPayloadExtractFields.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
| `payloadAlertFields` | PayloadAlertFieldType! => Array | List of parsed payload fields |
...
### PayloadAlertFieldType

Parsed fields from an alert used for custom mappings.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `label` | String | Human-readble label of the payload path |
| `path` | String | Path to value inside payload JSON |
