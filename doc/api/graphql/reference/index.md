...
| <a id="mutationrunnersregistrationtokenresetfullpath"></a>`fullPath` | [`ID`](#id) | Full path of the project or namespace to reset the token for. Omit if resetting instance runner token. |
