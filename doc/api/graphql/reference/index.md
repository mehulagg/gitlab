...
| `recaptchaSiteKey` | String | The reCAPTCHA site_key which must be used to render a challenge for the user to solve in order to obtain a valid recaptchaResponse value. |
| `snippet` | Snippet | The snippet after mutation. |
| `spam` | Boolean | Indicates whether the operation returns a record detected as spam. |
| `spamLogId` | Int | The spam log ID which must be returned along with a valid recaptchaResponse in order for the operation to be completed. |
