...
| <a id="mutationlabelcreateremoveonissueclose"></a>`removeOnIssueClose` | [`Boolean`](#boolean) | Boolean option specifying whether the label should be removed from issues when they are closed or not. |
...
| <a id="labelremoveonissueclose"></a>`removeOnIssueClose` | [`Boolean!`](#boolean) | Boolean option specifying whether the label should be removed from issues when they are closed or not. |
