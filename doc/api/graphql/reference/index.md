...
| <a id="projectcijobtokenallowlist"></a>`ciJobTokenAllowList` | [`ProjectConnection`](#projectconnection) | Allow list of projects with the CI Job token for this project. (see [Connections](#connections)) |
