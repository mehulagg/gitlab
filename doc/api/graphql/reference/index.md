...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `averageCoverage` | Float | Percentage of coverage for the project |
| `coverageCount` | Int | Number of coverages for the project |
| `lastUpdatedAt` | Time | Latest date of coverage for the project |
...
| `codeCoverage` | CodeCoverage | Code coverages associated with the project |
