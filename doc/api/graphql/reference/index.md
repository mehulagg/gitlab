...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `issuableAssigneesUpdated` | [`UpdatedAssignees`](#updatedassignees) | Triggered when the assignees of an issuable are updated. |
...
Represents updated information about an issuable's assignees.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `assignees` | [`[User!]`](#user) | Updated list of assignees of the issuable. |
