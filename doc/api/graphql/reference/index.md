...
### `IncidentManagementOncallScheduleID`

A `IncidentManagementOncallScheduleID` is a global ID. It is encoded as a string.

An example `IncidentManagementOncallScheduleID` is: `"gid://gitlab/IncidentManagement::OncallSchedule/1"`.
...
| <a id="escalationruleinputoncallscheduleid"></a>`oncallScheduleId` | [`IncidentManagementOncallScheduleID`](#incidentmanagementoncallscheduleid) | The on-call schedule to notify. |
