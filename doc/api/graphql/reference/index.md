...
### `ExportableEntitiesConnection`

The connection type for ExportableEntities.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `edges` | [`[ExportableEntitiesEdge]`](#exportableentitiesedge) | A list of edges. |
| `nodes` | [`[ExportableEntities]`](#exportableentities) | A list of nodes. |
| `pageInfo` | [`PageInfo!`](#pageinfo) | Information to aid in pagination. |

### `ExportableEntitiesEdge`
...
| ----- | ---- | ----------- |
| `cursor` | [`String!`](#string) | A cursor for use in pagination. |
| `node` | [`ExportableEntities`](#exportableentities) | The item at the end of the edge. |
...
| `exportableEntities` | [`ExportableEntitiesConnection`](#exportableentitiesconnection) | Exportable Types. |
