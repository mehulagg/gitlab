...
| Field | Type | Description |
| ----- | ---- | ----------- |
| `canLock` | [`Boolean`](#boolean) | Whether the current user is able to mark this file as locked. |
| `id` | [`ID!`](#id) | ID of the blob. |
| `isLocked` | [`Boolean`](#boolean) | Whether this file is currently locked. |
| `lfsOid` | [`String`](#string) | LFS OID of the blob. |
| `lockLink` | [`String`](#string) | Path to the endpoint used to toggle this file's lock status. |
