...
| `groupPackageSetting` | PackageSetting | The package settings for the group |
...
### UpdatePackageSettingsPayload

Autogenerated return type of UpdatePackageSettings.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
| `packageSetting` | PackageSetting | The group package setting after mutation. |
