...
| `groupPackageSetting` | GroupPackageSetting | The package settings for the group |
...
The group level package registry settings.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `mavenDuplicateExceptionRegex` | UntrustedRegexp | Packages with names matching this regex will be allowed when maven_duplicates_allowed is false. |
| `mavenDuplicatesAllowed` | Boolean! | Indicates whether duplicate Maven packages are allowed for this group. |
...
### UpdateGroupPackageSettingsPayload

Autogenerated return type of UpdateGroupPackageSettings.

| Field | Type | Description |
| ----- | ---- | ----------- |
| `clientMutationId` | String | A unique identifier for the client performing the mutation. |
| `errors` | String! => Array | Errors encountered during execution of the mutation. |
| `groupPackageSetting` | GroupPackageSetting | The group package setting after mutation. |
