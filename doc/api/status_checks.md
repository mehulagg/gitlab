...
> - To use it in GitLab self-managed instances, ask a GitLab administrator to [enable it](#enable-or-disable-status-checks).
...
The enable or disable external project-level merge request status checks feature is:
