...
Removes a billable member from a group and it's subgroups and projects. A billable user does not need to be a 
group member to qualify for removal, e.g. if directly added as a member of a project within a group.
