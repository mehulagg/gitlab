...
# GitLab.com subscription **(PREMIUM ONLY)**
...
source projects, GitLab grants access to **Ultimate** plan features for all GitLab.com
...
- **For individuals**:
  ...
  1. Visit the [billing page](https://gitlab.com/profile/billings)
     under your profile.
  1. Select the GitLab.com plan through the
...
or upgrade your account to a higher [tier](https://about.gitlab.com/pricing/).
