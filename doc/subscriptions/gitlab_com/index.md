...
1. Ensure the **Storage** tab is selected.
1. Select **Purchase more storage** and you will be directed to the Customers Portal.
1. Ensure the the correct group is selected in the **namespace** dropdown.
