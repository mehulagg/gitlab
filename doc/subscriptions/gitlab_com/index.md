...
If you add a member to a group by using the [share a group with another group](https://docs.gitlab.com/ee/user/group/#share-a-group-with-another-group) feature, you can't remove the member by using this method. Instead, you can either:
