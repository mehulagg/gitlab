...
- GitLab-created service accounts: `Ghost User` and bots [(`Support Bot`](../../user/project/service_desk.html#support-bot-user), [`Project bot users`](../../user/project/settings/project_access_tokens.md#project-bot-users), and so on).
