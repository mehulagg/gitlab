...
specified alongside `admin_group`. Also, only specify the CN of the administrator
...
1. Navigate to **(administrator)** **Admin Area > Settings -> Visibility and access controls**.
