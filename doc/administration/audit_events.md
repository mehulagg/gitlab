...
- A user requests to join an instance, their request is approved, or their request is rejected ([introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/298783) in GitLab 13.9.)
