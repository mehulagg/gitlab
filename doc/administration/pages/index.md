...
| `enable_disk`                           | Allows the GitLab Pages daemon to serve content from disk. Will default to `false` starting from 14.0. |
...
It means that **GitLab Rails** is telling Pages to serve content from a location on disk.
