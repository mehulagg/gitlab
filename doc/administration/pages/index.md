...
On large GitLab instances using API-based configuration will significanly improve pages daemon startup times as there is no need to load all custom domains configuration into memory. 
