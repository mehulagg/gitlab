...
|**[Report on users' permissions levels](../user/admin_area/index.md#user-permission-export)**<br>An administrator can generate a report of who has access to which groups and projects in the instance. | Premium+ | **{dotted-circle}** No | Instance |
