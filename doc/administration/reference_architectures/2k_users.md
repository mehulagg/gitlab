...
For information about configuring NFS, see the [NFS documentation page](../nfs.md). In GitLab 14.0, support for NFS for Git repositories is scheduled to be removed.
