...
See how to [configure NFS](../nfs.md). In GitLab 14.0, support for NFS for Git repositories is scheduled to be removed.NFS support is scheduled to be removed in GitLab 14.0. 
