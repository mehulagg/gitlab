...
| `geo_pages_deployments`                      | Gauge   | 14.1  | Number of pages deployments on primary | `url` |
| `geo_pages_deployments_checksum_total`       | Gauge   | 14.1  | Number of pages deployments tried to checksum on primary | `url` |
| `geo_pages_deployments_checksummed`          | Gauge   | 14.1  | Number of pages deployments successfully checksummed on primary | `url` |
| `geo_pages_deployments_checksum_failed`      | Gauge   | 14.1  | Number of pages deployments failed to calculate the checksum on primary | `url` |
| `geo_pages_deployments_synced`               | Gauge   | 14.1  | Number of syncable pages deployments synced on secondary | `url` |
| `geo_pages_deployments_failed`               | Gauge   | 14.1  | Number of syncable pages deployments failed to sync on secondary | `url` |
| `geo_pages_deployments_registry`             | Gauge   | 14.1  | Number of pages deployments in the registry | `url` |
| `geo_pages_deployments_verification_total`   | Gauge   | 14.1  | Number of pages deployments verifications tried on secondary | `url` |
| `geo_pages_deployments_verified`             | Gauge   | 14.1  | Number of pages deployments verified on secondary | `url` |
| `geo_pages_deployments_verification_failed`  | Gauge   | 14.1  | Number of pages deployments verifications failed on secondary | `url` |
