...
Because the container Registry requires a TLS certificate, in the end it all boils
...
This is not the port that GitLab itself uses to expose
...
Sometimes what's wrong is not obvious, and you may need to dive deeper into
