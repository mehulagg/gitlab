...
Users should now be able to log in to the Container Registry with their GitLab
credentials using:
...
Users should now be able to log in to the Container Registry using their GitLab
credentials:
...
Now that we have mitmproxy and Docker running, we can attempt to log in and push
