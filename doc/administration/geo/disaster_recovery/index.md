...
1. Connect to your primary Kubernetes cluster and disable the GitLab webservice and
   Sidekiq pods
...
1. If you do not have access to the **primary** Kubernetes cluster, take the cluster offline and
