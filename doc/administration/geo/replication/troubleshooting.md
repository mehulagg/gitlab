...
1. Check returns `not a secondary node`
   ...
   - Ensure that you entered the `external_url` or `gitlab_rails['geo_node_name']` when adding the secondary node in the administration are of the **primary** node.
...
This section documents common errors reported in the Administration UI and how to fix them.
