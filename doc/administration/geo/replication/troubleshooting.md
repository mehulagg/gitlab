...
During a backfill, failures are scheduled to be retried at the end of the backfill queue,
therefore these failures only clear up **after** the backfill completes.

There are more details about what backfilling is on the [Geo overview page](../index.md#backfill)
