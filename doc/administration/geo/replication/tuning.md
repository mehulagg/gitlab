...
You can limit the number of concurrent operations the secondary nodes can run
in the background.
...
1. Under **Tunning settings**, there are several variables that can be tuned to
