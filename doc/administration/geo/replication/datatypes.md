...
| [Container Registry](../../packages/container_registry.md)                                                     | **Yes** (12.3)                                                                     | No                                                        | No                                                                                | Disabled by default. See [instructions](https://docs.gitlab.com/ee/administration/geo/replication/docker_registry.html) to enable.                                                                                                                                                                                                                                                                                                                             |
