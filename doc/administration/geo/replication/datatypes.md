...
|[Project designs repository](../../../user/project/issues/design_management.md)                                | **Yes** (12.7)                                                          | [No](https://gitlab.com/gitlab-org/gitlab/-/issues/32467)               | Files Via Object Storage provider if supported. Native Geo support (Beta).    | Designs also require replication of LFS objects and Uploads. |
