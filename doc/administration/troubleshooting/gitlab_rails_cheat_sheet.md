...
You can find and store an array of projects based on an SQL query with `Project.find_by_sql`:
...
You can find and store an array of groups based on an SQL query with `Group.find_by_sql`:
