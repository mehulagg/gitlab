...
- Exposed as a local mount, with repositories accessible via group and project names as directory names. This [legacy storage method](repository_storage_paths.md#configure-repository-storage-paths)
