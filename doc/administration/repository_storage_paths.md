...
GitLab stores [repositories](../user/project/repository/index.md) on repository storage paths.
GitLab allows you to define multiple repository storage paths to distribute the storage load between
...
The `path` must be one of the available [repository storage types](repository_storage_types.md).
...
- Go to **Settings > Repository** and expand the **Repository storage** section.
