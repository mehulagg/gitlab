...
For example, in the form of missing commits. The problem may be partially mitigated by adjusting caching using the following NFS client mount options:
...
[Gitaly Cluster](https://docs.gitlab.com/ee/administration/gitaly/praefect.html) as soon as possible.
