...
| `cto` | Instead of `nocto`. [Further details](#nocto-mount-option).
...
We require using `cto` (which is the default), **instead** of `nocto`.
...
[described in the issue](https://gitlab.com/gitlab-org/gitlab/-/issues/326066#note_539436931).
