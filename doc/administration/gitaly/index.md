...
- GitLab installations for up to 2000 users, [specific Gitaly configuration instructions](../reference_architectures/2k_users.md#configure-gitaly).
...
file severs, rather than by using NFS mounts. This gave us a speed boost that counteracted the
