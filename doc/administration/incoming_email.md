...
We recommended to use an email address that **only** receives messages which are _intended for the GitLab instance_. Any incoming emails not intended for GitLab will receive a reject notice.
