...
hook added there applies to all repositories, including [project/group wiki](../user/project/wiki/index.md) or [design management](../user/project/issues/design_management.md) type repositories under a project.
