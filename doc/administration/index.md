...
- [Environment variables](environment_variables.md): Supported environment
  ...
  GitLab.
- [Plugins](file_hooks.md): With custom plugins, GitLab administrators can introduce custom integrations without modifying GitLab source code.
...
- [Elasticsearch](../integration/elasticsearch.md): Enable Elasticsearch to empower GitLab Advanced Search. Useful when you deal with a huge amount of data. **(STARTER ONLY)**
