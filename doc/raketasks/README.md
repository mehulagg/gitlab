...
| [Usage data](../administration/troubleshooting/gitlab_rails_cheat_sheet.md#generate-usage-ping)     | Generate and troubleshoot [Usage Ping](https://docs.gitlab.com/ee/development/product_analytics/usage_ping.html).|
