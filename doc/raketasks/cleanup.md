...
When you notice there are more job artifacts files and/or folders on disk than there
...
- If no database record is found, the file and folder is deleted from disk.
