        ...
        module Services
          class Jira < QA::Page::Base
            ...
            view 'app/assets/javascripts/integrations/edit/components/jira_trigger_fields.vue' do
              ...
              element :service_jira_issue_transition_automatic_true_radio, ':data-qa-selector="`service_jira_issue_transition_automatic_${issueTransitionOption.value}`"' # rubocop:disable QA/ElementWithPattern
              element :service_jira_issue_transition_automatic_false_radio, ':data-qa-selector="`service_jira_issue_transition_automatic_${issueTransitionOption.value}`"' # rubocop:disable QA/ElementWithPattern
            ...
            def use_automatic_transitions
              choose_element(:service_jira_issue_transition_automatic_true_radio)
            end

            def use_custom_transitions
              choose_element(:service_jira_issue_transition_automatic_false_radio)
            end
