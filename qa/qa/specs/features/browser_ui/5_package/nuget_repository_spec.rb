...
module QA
  RSpec.describe 'Package', :orchestrated, :packages do
    describe 'NuGet Repository' do
      ...
      it 'publishes a nuget package at the project level, installs and deletes it at the group level', quarantine: { issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/321425', type: :stale }, testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/1073' do
        Flow::Login.sign_in
