...
module QA
  RSpec.describe 'Package', :orchestrated, :packages do
    describe 'NuGet Repository' do
      ...
      it 'publishes a nuget package at the project level, installs and deletes the group level', testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/1073' do
        Flow::Login.sign_in
        ...
        Page::Group::Menu.perform(&:click_group_packages_link)
