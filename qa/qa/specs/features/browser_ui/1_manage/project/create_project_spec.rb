...
module QA
  RSpec.describe 'Manage', :smoke do
    describe 'Project creation' do
      it 'user creates a new project', testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/429', quarantine: { issue: https://gitlab.com/gitlab-org/gitlab/-/issues/280585, type: :investigating } do
        Flow::Login.sign_in
