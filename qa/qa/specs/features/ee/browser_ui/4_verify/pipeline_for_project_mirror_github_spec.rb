  ...
  context 'Verify', :github, :requires_admin, only: { subdomain: :staging } do
    ...
    describe 'Pipeline for project mirrors Github' do
      ...
      def edit_github_file
        QA::Runtime::Logger.info "Making changes to Github file."
