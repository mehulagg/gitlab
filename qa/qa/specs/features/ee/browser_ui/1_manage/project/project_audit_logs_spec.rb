...
module QA
  RSpec.describe 'Manage' do
    ...
    describe 'Project', :requires_admin do
      ...
      context "Export file download", testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/1127', quarantine: { only: { pipeline: [:staging, :production] }, issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/296212', type: :bug } do
        before do
