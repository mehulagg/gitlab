...
module QA
  RSpec.describe 'Manage' do
    ...
    describe 'Project' do
      ...
      context "Export file download", testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/743', quarantine: { issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/296212', only: { subdomain: :staging }, type: :bug } do
        before do
