...
module QA
  RSpec.describe 'Secure', :runner do
    describe 'Security Dashboard in a Project' do
      ...
      let(:test_label) { "severity 3" }
      let(:test_description) { "Test Vulnerability edited comment" }
      ...
      before(:all) do
        ...
        @label = Resource::Label.fabricate_via_api! do | l |
          l.project = @project
          l.title = "severity 3"
        end
      end
      ...
      it 'creates an issue from vulnerability details', testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/1140' do
        Page::Project::Menu.perform(&:click_on_vulnerability_report)
        ...
        Page::Project::Issue::New.perform do |new_page|
          new_page.fill_description(test_description)
        ...
        Page::Project::Issue::Show.perform do |issue|
          ...
          expect(issue).to have_text(test_description)
          expect(issue).to have_label(@label)
        end
      end
    end
  end
