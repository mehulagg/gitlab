...
module QA
  RSpec.describe 'Plan', :reliable do
    describe 'Group Iterations' do
      ...
      it 'creates a group iteration', testcase: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/1174', quarantine: { issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/334252', type: :broken_test } do
