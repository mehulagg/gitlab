...
module QA
  RSpec.describe 'Create' do
    context 'Gitaly' do
      ...
      describe 'Distributed reads', :orchestrated, :gitaly_cluster, :skip_live_env, :requires_admin, quarantine: { issue: 'https://gitlab.com/gitlab-org/quality/testcases/-/issues/980', type: :investigating } do
